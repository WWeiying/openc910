...
![图 1：Redwood Cove 核心总览](intel_redwood_cove_figures/01_figure.png)
...
![图 2：Redwood Cove 长 Pattern 延迟](intel_redwood_cove_figures/02_figure.png)

*图 2：现象支持“小而快 Global Predictor 被更准 Level Override”的假说；Second Level 只多 1 cycle。具体 Predictor Organization 未公开。*

![图 3：Golden Cove 对照](intel_redwood_cove_figures/03_figure.png)
...
![图 4：BTB Capacity/Latency](intel_redwood_cove_figures/04_figure.png)
...
![图 5：L1I Instruction Bandwidth](intel_redwood_cove_figures/05_figure.png)
...
![图 6：Op Cache 容量与 PMU](intel_redwood_cove_figures/06_figure.png)
...
![图 7：DSB/MITE/LSD 的 PMU 来源](intel_redwood_cove_figures/07_figure.png)

*图 7：正式图注说明 Intel 把 Op Cache 称 Decoded Stream Buffer（DSB），Decoder 称 Micro-Instruction Translation Engine（MITE）。*

![图 8：Redwood Cove 的 Loop Coverage](intel_redwood_cove_figures/08_figure.png)

*图 8：LSD 在 xalancbmk、gcc、x264 占明显比例，其他应用一般或很小。*

![图 9：Zen 4 Loop Buffer 对照](intel_redwood_cove_figures/09_figure.png)

*图 9：正式图注提醒 AMD 无 Microcoded 独立类别，且 Zen 4 Op Cache 可缓存 Microcoded Instruction，分类不可直接一一对应。*

![图 10：SPEC CPU2017 FP 的 Loop Coverage](intel_redwood_cove_figures/10_figure.png)
...
![图 11：SPEC CPU2017 Integer 的 Micro-op/Instruction](intel_redwood_cove_figures/11_figure.png)
...
![图 13：Cache Latency（2 MB Page）](intel_redwood_cove_figures/13_figure.png)
...
![图 14：Redwood Cove Cache Bandwidth](intel_redwood_cove_figures/14_figure.png)

*图 14：更多 MLP 被 Meteor Lake 较高 Cache/Memory Latency 与较低 Clock 抵消。Golden Cove 数据来自 Raichu 旧版测试，原帖已不可用，方法版本不同。*

![图 15：Read-modify-write Bandwidth](intel_redwood_cove_figures/15_figure.jpg)
...
![图 16：LLC Page Prefetcher 说明](intel_redwood_cove_figures/16_figure.png)
...
![图 17：AOP Latency 测试](intel_redwood_cove_figures/17_figure.png)
...
![图 18：Redwood Cove SMT Resource Sharing](intel_redwood_cove_figures/18_figure.jpg)
...
![图 20：SPEC CPU2017 Integer SMT Scaling](intel_redwood_cove_figures/20_figure.png)

*图 20：Redwood Cove Integer Throughput +17.6%。SPEC Version、Compiler 与 Flags 明确，但平台功耗、Run-to-run Error 等仍需随网页条件理解。*

![图 21：SPEC CPU2017 FP SMT Scaling](intel_redwood_cove_figures/21_figure.png)
...
![图 22：Meteor Lake System/Tick 背景](intel_redwood_cove_figures/22_figure.jpg)
