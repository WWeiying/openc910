...
themeName: "学术论文 (副本)"
title: "intel_meteor_lake_ces_wechat_article_zh"
---
...
![图 2：Intel 展示 P-Core、E-Core、LPE-Core 三种核心](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/d0de2e6f5ecccad9_02_figure.jpg)

## Redwood Cove P-Core

Redwood Cove 基本继承 Raptor Cove 私有缓存：48 KB L1D/5 cycle、2 MB L2/16 cycle。Zen 4 为 32 KB/4 cycle、1 MB L2/14 cycle。

![图 3：大页测试下 P-Core cache/memory 延迟（cycle）](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/5f7b789e9420e632_03_figure.png)
...
![图 5：P-Core cache/memory 单核带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/68132d43b689153d_05_figure.png)
...
![图 9：三类核心 cache hierarchy](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/703504575458318e_09_figure.png)

2.48 GHz 让 20 cycle L2 接近 8 ns；DRAM 超 200 ns。即便靠近 memory controller，路径可能为低功耗而非性能优化。

![图 10：LPE-Core 延迟曲线](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/786c7f4a4999342a_10_figure.png)

带宽受低频和窄通路限制：L1 略低于 80 GB/s，即约 32 B/cycle；L2 24—25 B/cycle、实际略超 62 GB/s；单核 memory 略低于 9 GB/s。

![图 11：LPE-Core 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/d8a9ae2e0885ba02_11_figure.png)
...
![图 12：Meteor Lake 三类核心的 core-to-core latency 矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/5774767adae13184_12_figure.png)

LPE-Core cluster 内接近 100 ns，跨到 Compute Tile 更高。

![图 13：Alder Lake 对照，最差仍低于 60 ns](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/d1314f0169a9a9d2_13_figure.png)
...
![图 14：Intel Tech Tour 的 Meteor Lake 分解架构](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_meteor_lake_ces_wechat_article_zh/2256e31597a65379_14_figure.jpg)
