...
![图 1：Golden Cove 与 Rocket Lake 的性能—功率曲线](intel_rocket_lake_power_figures/01_figure.png)
...
![图 2：Rocket Lake、Skylake、Kaby Lake 与 Golden Cove 的 libx264 性能—封装功率](intel_rocket_lake_power_figures/02_figure.png)
...
![图 4：7-Zip 压缩性能—封装功率](intel_rocket_lake_power_figures/04_figure.png)

Kaby Lake、Rocket Lake、Golden Cove 的差距不大；i5-6600K 的异常曲线原因未知，必须保留为未解释结果。Rocket Lake 仍在 35 W 以上超过 Kaby Lake，低功率缩放依旧很差。

![图 5：7-Zip 完成任务的总能量](intel_rocket_lake_power_figures/05_figure.png)
...
![图 6：整数负载中 Gracemont 与 Rocket Lake 的可互补区间](intel_rocket_lake_power_figures/06_figure.png)
...
![图 7：libx264 中 Rocket Lake、Skylake 与 Goldmont Plus 的核心功率曲线](intel_rocket_lake_power_figures/07_figure.png)

Rocket Lake 无法进入极低功率，Goldmont Plus 又无法向高功率扩展，两者之间留下明显功率和性能空档，Skylake 恰好落在中间。

![图 8：7-Zip 中三种核心的核心功率曲线](intel_rocket_lake_power_figures/08_figure.png)
