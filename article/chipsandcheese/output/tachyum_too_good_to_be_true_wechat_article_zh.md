...
![图 1：早期 Prodigy 的 Gshare 预测器与现代方案比较](tachyum_too_good_to_be_true_figures/01_figure.png)
...
![图 2：Prodigy 与多代 CPU 的 BTB 容量/速度档位](tachyum_too_good_to_be_true_figures/02_figure.jpg)
...
![图 7：2018 Prodigy 与 Skylake-X 向量后端比较](tachyum_too_good_to_be_true_figures/07_figure.png)
...
![图 8：早期披露的 DRAM 带宽；2 TB/s 带星号项依赖未说明的带宽放大](tachyum_too_good_to_be_true_figures/08_figure.png)

文章不把“Bandwidth Amplification Technology”计入结论，因为没有机制资料。即便按约 1 TB/s，Prodigy 的 FP64 计算/内存带宽比也明显偏高。

![图 9：Prodigy 与 CPU/GPU 的 FP64 FLOP/Byte 比较](tachyum_too_good_to_be_true_figures/09_figure.jpg)

程序必须依靠 Cache 高复用来利用向量，但缓存总量不大。2022 方案还去掉 HBM 和 Ethernet，改为统一 PCIe 5.0，并把 DDR 总线翻倍。

![图 10：2018 与 2022 的内存、I/O 配置变化](tachyum_too_good_to_be_true_figures/10_figure.jpg)
...
![图 11：不同 Prodigy SKU 的核心、频率与 TDP](tachyum_too_good_to_be_true_figures/11_figure.png)
...
![图 12：早期 Prodigy 的 Bundle/端口绑定](tachyum_too_good_to_be_true_figures/12_figure.png)
...
![图 13：Tachyum 当时公布的产品路线图](tachyum_too_good_to_be_true_figures/13_figure.png)
