...
![图 1：被测 Ryzen 9 9900X](amd_zen5_gaming_figures/01_figure.jpg)
...
![图 2：Zen 5 游戏负载的 Top-Down 结果](amd_zen5_gaming_figures/02_figure.png)
...
![图 3：Op Cache 覆盖、L1I/L2 Code 命中与分支准确率](amd_zen5_gaming_figures/03_figure.png)
...
![图 4：Zen 5 与 Lion Cove 的前端事件](amd_zen5_gaming_figures/04_figure.png)
...
![图 5：前端 Latency Bound 的平均持续时间](amd_zen5_gaming_figures/05_figure.png)
...
![图 6：Op Cache 与 Decoder 活跃周期占比](amd_zen5_gaming_figures/06_figure.png)

*图 6：Op Cache 活跃约 14%～21% 的总 cycle，Decoder 约 4.5%～5.3%；剩余时间大量处于后端停顿或无供给。百分比不能直接当成前端空闲原因。*

![图 7：Op Cache 与 Decoder 的平均微操作吞吐](amd_zen5_gaming_figures/07_figure.png)
...
![图 8：Op Cache 吞吐与分支比例](amd_zen5_gaming_figures/08_figure.png)
...
![图 9：Zen 5 Dispatch Resource Stall](amd_zen5_gaming_figures/09_figure.png)
...
![图 10：后端与 L1D Miss 的平均持续时间](amd_zen5_gaming_figures/10_figure.png)

*图 10：Retire Blocked by Load 约 18～20 cycle，L1D Miss Latency 可到数十或上百 cycle。Palworld 的平均 miss 较短，不代表更轻松，而是它有更多落在 L2 的 miss。*

![图 11：Demand L1D Fill 来源/千指令](amd_zen5_gaming_figures/11_figure.png)
...
![图 12：Zen 5 与 Lion Cove 的 L1D Miss 来源](amd_zen5_gaming_figures/12_figure.png)
...
![图 13：L3 Miss 的本地 DRAM 与跨 CCX 延迟](amd_zen5_gaming_figures/13_figure.png)
...
![图 14：单 CCX 与跨两个 CCX 的 Cyberpunk 结果](amd_zen5_gaming_figures/14_figure.png)
...
![图 15：游戏与 SPEC CPU2017 的 Zen 5 平均 IPC](amd_zen5_gaming_figures/15_figure.png)
...
![图 16：Cyberpunk 运行期间的 Windows 调度时间线](amd_zen5_gaming_figures/16_figure.jpg)

*图 16：自然调度把主要工作集中在一颗 CCD。线程出现在哪颗逻辑处理器，比“芯片有两个 CCD”这个静态事实更直接影响跨区流量。*

![图 17：AMD 对跨 CCX Refill 的路径说明](amd_zen5_gaming_figures/17_figure.png)
