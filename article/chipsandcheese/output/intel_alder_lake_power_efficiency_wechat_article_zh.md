...
![图 1：Intel 给出的 P-Core/E-Core 性能与功率关系](intel_alder_lake_power_efficiency_figures/01_figure.jpg)

图 1 的官方数据看起来对 E-Core 很不利：任何功率点都未超过 P-Core，似乎只剩面积效率优势。下面用具体负载复测。

![图 2：四核 libx264 向量化编码的性能—功率曲线](intel_alder_lake_power_efficiency_figures/02_figure.jpg)

libx264 中超过 17% 指令是 256-bit 向量指令，而 Gracemont 会把它们拆成两个 128-bit 操作。结果是，只有四核总功率低于约 6 W、接近超轻薄本强节流区时，Gracemont 才超过 Golden Cove。

![图 3：四核 7-Zip 整数压缩的性能—功率曲线](intel_alder_lake_power_efficiency_figures/03_figure.jpg)
...
![图 4：libx264 在不同频率下完成任务的总核心能量](intel_alder_lake_power_efficiency_figures/04_figure.jpg)
...
![图 6：libx264 中 Gracemont 与 Skylake 的性能—功率关系](intel_alder_lake_power_efficiency_figures/06_figure.jpg)

![图 7：7-Zip 中 Gracemont 与 Skylake 的性能—功率关系](intel_alder_lake_power_efficiency_figures/07_figure.jpg)
...
![图 8：libx264 中 Golden Cove 与 Skylake 的性能—功率关系](intel_alder_lake_power_efficiency_figures/08_figure.jpg)
...
![图 10：桌面 Zen 2 与 Alder Lake 在 libx264 中的性能—核心功率](intel_alder_lake_power_efficiency_figures/10_figure.jpg)

![图 11：桌面 Zen 2 与 Alder Lake 在 7-Zip 中的性能—核心功率](intel_alder_lake_power_efficiency_figures/11_figure.jpg)
...
![图 12：移动 Renoir Zen 2 的 libx264 性能—功率曲线](intel_alder_lake_power_efficiency_figures/12_figure.jpg)

![图 13：移动 Renoir Zen 2 的 7-Zip 性能—功率曲线](intel_alder_lake_power_efficiency_figures/13_figure.png)

移动 Renoir 与桌面 Zen 2 表现得像两个不同定位的核心：15 W 以下胜过两种 Alder Lake 核心，并在所有可比点胜过 Gracemont；但高功率扩展比桌面 Zen 2 更弱，更不及 Golden Cove。

![图 14：libx264 在相近频率下的总能量对比](intel_alder_lake_power_efficiency_figures/14_figure.jpg)

![图 15：7-Zip 在相近频率下的总能量对比](intel_alder_lake_power_efficiency_figures/15_figure.jpg)
