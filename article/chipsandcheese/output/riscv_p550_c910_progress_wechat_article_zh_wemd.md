...
themeName: "学术论文 (副本)"
title: "riscv_p550_c910_progress_wechat_article_zh"
---
...
![图 1：RISC-V 从小型顺序核走向高性能乱序核](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/4ab84a27068c8768_01_figure.jpg)
...
![图 3：SPEC CPU2017 总体性能](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/2c45f8db89bf53d4_03_figure.png)
...
![图 4：SPEC CPU2017 整数子项逐项比较](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/a3338eb5b3547185_04_figure.jpg)

C910 在整数子项中没有一项战胜频率更低的 P550；浮点项目里它能赢下一些子项，却仍未取得总体领先。A73 和 Goldmont Plus 则较好地把频率优势转化为实际成绩。

![图 5：SPEC CPU2017 浮点子项逐项比较](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/9b789733a09b0982_05_figure.jpg)

图 4、图 5 应按子项理解，不能从某一个项目外推整颗处理器。编译器、内存延迟以及不同 SoC 的频率策略都进入了结果。

![图 6：SPEC CPU2017 整数套件 IPC](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/ca5f8d94bcf62ec8_06_figure.png)
...
![图 7：SPEC CPU2017 浮点套件 IPC](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/cf6f215388c31380_07_figure.png)
...
![图 8：四线程 7-Zip 压缩性能](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/1d1ccdcec8fa5fb7_08_figure.jpg)

C910 与 P550 成绩接近，并略落后于 Genio 1200 上的 Cortex-A55，再次说明频率和存储系统良好的顺序核仍能很有竞争力。

![图 9：不同 SoC 中 Cortex-A55 的 7-Zip 表现](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/f24e870a713591a4_09_figure.jpg)

Snapdragon 855 和 670 中的 A55 频率更低、DRAM 延迟更高，因此反而落后于 P550 和 C910。同一核心 IP 在不同芯片中可以有很大的性能差异。

![图 10：7-Zip 的 IPC 与计数器结果](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/94e996647d07688a_10_figure.png)
...
![图 11：SHA-256 校验性能](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/20c37dac1f4d827f_11_figure.png)

Cortex-A55 意外取得明显领先。这类规则、短依赖且访存压力低的代码很适合顺序流水线，A55 的 IPC 甚至高于 A73。

![图 12：SHA-256 的 IPC](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/1c752eaa707e319e_12_figure.png)

三宽核心也能发挥：P550 和 Goldmont Plus 稳定超过 2 IPC，C910 接近 2 IPC。

![图 13：完成 SHA-256 所需的动态指令数](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/170e23461b04f208_13_figure.png)
...
![图 14：x264 检测到的指令集能力](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/0fcf25307fa987a0_14_figure.png)

C910 支持 RVV 0.7.1，但 libx264 没有任何 RISC-V 扩展的汇编实现。于是 A73 和 Goldmont Plus 处于完全不同的性能档位，连 A55 也明显领先。

![图 15：x264 编码性能](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/9f0869f6fe271eb0_15_figure.png)

这不是单纯的核心硬件排名，而是硬件、指令集扩展成熟度与软件实现共同作用的结果。

![图 16：x264 的 IPC](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/e2b48a207e556400_16_figure.png)
...
![图 18：两颗 RISC-V 乱序核心所在的平台](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/riscv_p550_c910_progress_wechat_article_zh/f05b8e6c49de442e_18_figure.jpg)
