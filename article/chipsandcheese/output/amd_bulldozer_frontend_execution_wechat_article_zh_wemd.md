...
themeName: "学术论文 (副本)"
title: "amd_bulldozer_frontend_execution_wechat_article_zh"
---
...
![图 1：用于测试的 AMD FX/Bulldozer](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/baaeb58c0e513cd2_01_fx_chip.jpg)
...
![图 2：本文使用的 AMD 架构代号](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/d910f552fe729ce1_02_codename_overview.jpg)
...
![图 3：Bulldozer Module 结构](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/6063b4f4c2c8c3fb_03_module_block_diagram.png)
...
![图 4：Bulldozer Module 与 K10 的物理形态](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/56751e4912a0c0b2_04_module_floorplan.jpg)
...
![图 5：Bulldozer 分支预测资源](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/84de63853ee2ab7a_05_branch_predictor_overview.jpg)
...
![图 6：Bulldozer 的随机分支模式识别](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/8be6718bb49c8fe7_06_bulldozer_branch_pattern.png)

*图 6：较短 Pattern/较少 Branch 时稳定，规模增加后低延迟平台快速破裂。*

![图 7：Sandy Bridge 的同类分支测试](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/dfc8cf66d80a4c78_07_sandy_bridge_branch_pattern.jpg)
...
![图 8：Bulldozer 的 BTB 容量与延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/366f0fd9f95104f0_08_btb_capacity.png)

*图 8：约 512-entry L1 BTB 后进入慢层。Sandy Bridge 的 4096-entry L1 BTB 与 Bulldozer 512 项同样快，还能零 Bubble 处理最多八个 Taken Branch。*

![图 9：双线程下的 Branch Target 吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/2cc0b7a680aaa033_09_dual_thread_branch_targets.png)
...
![图 10：8-byte NOP 的 Fetch Byte Bandwidth](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/ea1c503ed85ab2e3_10_instruction_fetch_bytes.png)
...
![图 11：4-byte NOP 的 Instruction Fetch IPC](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/abf3aa96c6da72df_11_instruction_fetch_ipc.png)
...
![图 12：Zeroing Idiom 的 Rename 行为](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/8060e838a57a2e15_12_zero_idiom.jpg)
...
![图 13：单线程可访问的 Bulldozer/Sandy Bridge 资源](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/9fd7c62b5aa850dd_13_ooo_resources.jpg)

*图 13：图表还标出双线程时的 Partition/Watermark。Sandy Bridge 多数资源会静态分割或设上限；Bulldozer 私有 Integer Window 与竞争式共享 FPU 行为不同。网页正式图注说明口径。*

![图 14：K10 Dispatch Stall 原因](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/4cb09c6099d2073a_14_k10_dispatch_stalls.png)
...
![图 15：Bulldozer 从 Rename 到 Execute 的四级路径](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/7cc8683a284a072e_15_bulldozer_rename_execute.png)

*图 15：大 Unified Scheduler 并未要求极深 Pipeline，Rename 到 Execute 约四阶段。网页正式图注说明范围。*

![图 16：P6/NetBurst 的对应路径](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/a43a958347a5e7b7_16_p6_netburst_pipeline.png)

*图 16：红框标出 Rename→Execute；NetBurst 阶段数超过两倍。Ancestry Approximation、PRF 与布局优化共同帮助 Bulldozer 守住频率。*

![图 17：每线程 Integer Engine 布局](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/9979f4ca9bd99e9c_17_integer_engine_layout.jpg)
...
![图 18：Integer Scheduler 与寄存器端口](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/453ef62f352b3e26_18_integer_scheduler_ports.png)
...
![图 19：Bulldozer FPU 物理布局](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/f76edab95a46b09f_19_fpu_layout.jpg)

*图 19：AMD ISSCC 图。RF 分成左右两个 10-bank Array，其中一侧更宽以支持 80-bit x87；跨完整 Vector Lane 的单元置于两阵列之间。*

![图 20：FP Register File 到执行单元的 Bus](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/84124a2e8048f004_20_fp_register_buses.png)
...
![图 21：单/双线程下的 Bulldozer FPU 容量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/06865e379abb7c60_21_fpu_resources.jpg)

*图 21：没有突然“容量减半”的台阶，符合 Thread-agnostic、竞争共享。*

![图 22：两线程竞争 FPU 的渐进变化](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/623d77768507c09f_22_fpu_competitive_sharing.png)
...
![图 23：Sandy Bridge 的 FP RF 分区](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/0984ba4bb02ae613_23_sandy_bridge_fp_rf_partition.png)

*图 23：网页正式图注明确 Dummy Thread 不使用 FP，FP RF 仍减半。*

![图 24：Sandy Bridge 的 Scheduler Watermark](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/a3e76b3a153270b0_24_sandy_bridge_scheduler_partition.png)
...
![图 25：Bulldozer 与 Sandy Bridge 的 Vector Port](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/46552a4dd5c40f87_25_avx_execution.png)
...
![图 26：FMA Throughput 与 Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/398a124cc4d84ff4_26_fma_latency.jpg)
...
![图 27：Bulldozer Store-to-load Forwarding](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/4f6f9af20c3f68e9_27_bulldozer_store_forwarding.png)

*图 27：覆盖范围比 K10 广，成功/失败区域的周期都更高。网页正式图注说明矩阵对象。*

![图 28：K10 Store-to-load Forwarding](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/cff0bfc29946b2fa_28_k10_store_forwarding.png)
...
![图 29：Sandy Bridge Store-to-load Forwarding](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/7c5918211b83fe59_29_sandy_bridge_store_forwarding.png)
...
![图 30：Bulldozer 的 4K Aliasing](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/456ca457742d6fae_30_bulldozer_4k_aliasing.png)
...
![图 31：Sandy Bridge 的 4K Aliasing](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_bulldozer_frontend_execution_wechat_article_zh/e07486a17a3eb379_31_sandy_bridge_4k_aliasing.png)
