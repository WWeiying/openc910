...
themeName: "学术论文 (副本)"
title: "amd_zen4_part1_wechat_article_zh"
---
...
![图 1：Zen 4 微架构总览](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/ba9b1e2f47a4389f_01_zen4_microarchitecture.png)

*图 1：Zen 4 保持六宽重命名与 Zen 3 类似的调度/执行组织，同时扩大微操作 Cache、ROB、物理寄存器、TLB 和 L2，并把向量寄存器扩到 512 bit。框图是公开资料与微基准复原，不是 RTL。*

![图 2：Zen 3 微架构总览](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/e943f8fc6815f173_02_zen3_microarchitecture.png)
...
![图 3：Zen 4 的方向模式识别](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/5ec864908accca2a_03_zen4_direction_pattern.png)

*图 3：Zen 4 的长模式区域仍保持低惩罚平台，随后才因历史、容量或 aliasing 退化。三维曲面反映整套预测器有效能力，不能单独读出 GHR 位数。*

![图 4：Zen 3 的方向模式识别](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/09e10a9bab142564_04_zen3_direction_pattern.jpg)
...
![图 5：大量分支下的 Zen 4 方向预测](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/5ec864908accca2a_05_zen4_many_branches.png)

*图 5：静态分支数最多扩到 512。Zen 4 在高分支压力下仍能维持较长模式，体现 L2 预测表的容量与抗混叠能力。*

![图 6：Golden Cove 的对应方向模式](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/7a280503145da67c_06_golden_cove_direction_pattern.jpg)
...
![图 7：Zen 4 的 BTB 容量与延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/69b88097b476bb75_07_zen4_btb_capacity.png)
...
![图 8：Zen 4、Zen 3 与 Golden Cove 的 BTB 对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/6119e6505ca580b7_08_btb_capacity_comparison.png)
...
![图 9：Zen 4 单分支多目标模式](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/7c637eed9f427296_09_zen4_indirect_target_pattern.png)

*图 9：同时改变目标数量与重复模式，观察间接目标阵列的有效历史与容量。目标越多，选择代价逐渐增加，但预测并未在 32 后立即失效。*

![图 10：Zen 3 单分支多目标模式](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/1ecc8dc19ac17e8f_10_zen3_indirect_target_pattern.jpg)
...
![图 11：大量间接分支下的 Zen 4](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/7c637eed9f427296_11_zen4_indirect_many_branches.png)

*图 11：Zen 4 在大量分支参与时保持更大的目标跟踪范围，体现阵列总容量优势。*

![图 12：Golden Cove 的间接目标预测](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/c61b8ecb3a917624_12_golden_cove_indirect_targets.jpg)
...
![图 13：Return Stack 深度](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/4d0bf3178f7c256b_13_return_stack_depth.png)
...
![图 14：八字节 NOP 的取指带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/a711085d0a1e8368_14_fetch_bandwidth_8b_nop.png)
...
![图 15：四字节 NOP 的异常高吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/442c66ef22cf65f8_15_fetch_bandwidth_4b_nop.png)
...
![图 16：两字节 XOR 的前端吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/317da30f64b9c9c0_16_fetch_bandwidth_xor.png)
...
![图 17：MOV、清零和立即数操作的重命名表现](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/f25e05c4e3c4fd94_17_rename_optimization_table.jpg)
...
![图 18：清零操作是否消耗物理寄存器](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/ac6673b46bb78819_18_zeroing_register_allocation.jpg)
...
![图 19：Zen 4、Zen 3 与 Golden Cove 的乱序资源](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/b638e8ad37436a2e_19_backend_resource_capacity.jpg)
...
![图 20：Zen 4/Zen 3 调度执行与 Golden Cove 对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/9593f9e7f4353bff_20_scheduler_execution_layout.png)
...
![图 21：AMD 对 Zen 4 AVX-512 的公开说明](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/5ab2b9aa176ddf40_21_amd_avx512_slide.png)
...
![图 22：Zen 4、Intel 与 Zen 2 的向量执行资源](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/73c9faac85887b5d_22_vector_execution_resources.png)
...
![图 24：不同 AVX-512 实现路线比较](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/aab9d70ec6bb1a40_24_avx512_implementation_comparison.jpg)
...
![图 25：Lemire 整数转字符串测试](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_zen4_part1_wechat_article_zh/3b795b2af4f2a0a9_25_lemire_integer_to_string.png)
