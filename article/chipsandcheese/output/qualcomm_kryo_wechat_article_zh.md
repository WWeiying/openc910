...
![图 1：Snapdragon 821 的两组 Kryo Cluster](qualcomm_kryo_figures/01_big_little_clusters.png)
...
![图 2：Kryo 微架构总览](qualcomm_kryo_figures/02_kryo_block_diagram.png)
...
![图 3：Kryo 的随机分支模式识别](qualcomm_kryo_figures/03_kryo_branch_pattern.png)

*图 3：单个或少量 Branch 的 Pattern 加长后，低延迟区域逐步破裂。曲面反映 History、Capacity 与 Aliasing 的共同影响，不能据此确认具体算法。*

![图 4：Cortex-A72 的同类分支模式测试](qualcomm_kryo_figures/04_a72_branch_pattern.jpg)
...
![图 5：Kryo 的 Taken Branch 延迟](qualcomm_kryo_figures/05_branch_target_latency.png)
...
![图 6：Kryo 与 A72 的 Branch Footprint 对照](qualcomm_kryo_figures/06_kryo_a72_branch_targets.png)
...
![图 7：Kryo 的 Indirect Target 容量](qualcomm_kryo_figures/07_indirect_target_prediction.png)
...
![图 8：Kryo 与 A72 的 Return Stack 深度](qualcomm_kryo_figures/08_return_stack.png)
...
![图 9：Kryo、A72 与桌面核的代码供给](qualcomm_kryo_figures/09_instruction_fetch_bandwidth.png)
...
![图 10：Kryo 与 A72 的乱序资源容量](qualcomm_kryo_figures/10_ooo_capacity.jpg)
...
![图 11：Kryo 与 A72 的 Scheduler 组织](qualcomm_kryo_figures/11_scheduler_capacity.png)
...
![图 12：Kryo 与 A72 的执行单元能力](qualcomm_kryo_figures/12_execution_units.jpg)
...
![图 13：Kryo 的 Store-to-load Forwarding](qualcomm_kryo_figures/13_kryo_store_forwarding.png)
...
![图 14：Cortex-A72 的 Store Forwarding 对照](qualcomm_kryo_figures/14_a72_store_forwarding.jpg)
...
![图 15：Big/Little Kryo 的 Cache/Memory 延迟](qualcomm_kryo_figures/15_cache_memory_latency.png)
...
![图 16：Kryo 与 A72 的 L1/L2 带宽](qualcomm_kryo_figures/16_l1_l2_bandwidth.png)
...
![图 17：多核 L2 读取带宽](qualcomm_kryo_figures/17_multicore_l2_bandwidth.png)
...
![图 18：Snapdragon 821 与 Graviton 1 的 DRAM 带宽](qualcomm_kryo_figures/18_dram_bandwidth.png)
...
![图 19：Big/Little Kryo 的核间延迟](qualcomm_kryo_figures/19_core_to_core_latency.png)
...
![图 20：同期移动核心面积对照](qualcomm_kryo_figures/20_mobile_core_area.png)
