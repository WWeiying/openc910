...
![图 1：Intel AMX Programming Reference 早已为 TMUL 之外的 Accelerator Type 预留编号，ACE 对应 Accelerator 2](x86_ace_readiness_figures/01_figure.jpg)
...
![图 2：AMX TMUL 的 Tile 配置与矩阵乘数据流](x86_ace_readiness_figures/02_figure.png)
...
![图 3：ACE 固定 Tile 与 Outer-product Instruction 组织](x86_ace_readiness_figures/03_figure.png)
...
![图 4：Arm 展示的以 SME Outer Product 重写 FFT 的示例](x86_ace_readiness_figures/04_figure.png)
...
![图 5：ACE 以 VUNPACKB 与 VPERM(2I)B 两步完成 2～7 bit 灵活转换](x86_ace_readiness_figures/05_figure.png)
...
![图 6：SME2 用 ZT0 一条 LUT 指令完成转换](x86_ace_readiness_figures/06_figure.png)
...
![图 7：ACE v1 Specification 中带 Block Scale 的 Outer Product](x86_ace_readiness_figures/07_figure.png)
...
![图 8：2×2 Tile 覆盖时一个 Input Tile 只被三个 Output Tile 复用；3×3 时要为五个 Output Tile 加载](x86_ace_readiness_figures/08_figure.png)
...
![图 9：AVX-512 VNNI 的 16×24 Accumulator Tiling](x86_ace_readiness_figures/09_figure.png)
...
![图 10：512 bit SME 的 32×32 Accumulator](x86_ace_readiness_figures/10_figure.png)
...
![图 11：AMX 以六个 Tile 保存 32×48 Accumulator](x86_ace_readiness_figures/11_figure.png)
...
![图 12：ACE 的 32×64 Accumulator Tiling](x86_ace_readiness_figures/12_figure.png)
