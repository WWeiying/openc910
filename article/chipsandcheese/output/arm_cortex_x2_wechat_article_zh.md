...
![图 1：Zenfone 9 中 Cortex-X2 的 Boost 过程](arm_cortex_x2_figures/01_x2_boost_behavior.png)
...
![图 2：Cortex-X2 核心总览](arm_cortex_x2_figures/02_cortex_x2_overview.jpg)
...
![图 3：Cortex-X2 的方向模式识别](arm_cortex_x2_figures/03_x2_branch_pattern.png)

*图 3：低延迟平台覆盖较长 Pattern 和较大静态分支数；转折之后同时包含历史不足、容量与混叠，无法据此唯一确定预测算法。*

![图 4：Neoverse N2 的方向模式识别](arm_cortex_x2_figures/04_neoverse_n2_branch_pattern.jpg)

*图 4：服务器 N2 的同类曲面略弱于 X2，说明 X 系列确实把额外预算投入预测器。测试平台和频率不同。*

![图 5：Cortex-A710 的方向模式识别](arm_cortex_x2_figures/05_cortex_a710_branch_pattern.png)

*图 5：A710 与 X2 同宗，形态接近，但 X2 的稳定区域更大。比较的是受控模式，不是实际程序预测正确率。*

![图 6：Zen 4 的方向模式识别](arm_cortex_x2_figures/06_zen4_branch_pattern.jpg)
...
![图 7：Cortex-X2 的 BTB 容量与延迟](arm_cortex_x2_figures/07_x2_btb_capacity.png)
...
![图 8：X2、A710 与 Zen 4 前端](arm_cortex_x2_figures/08_frontend_x2_a710_zen4.png)
...
![图 9：Cortex-X2 与 Zen 4 的前端供给](arm_cortex_x2_figures/09_frontend_bandwidth.png)
...
![图 10：X2、A710 与 Zen 4 的乱序资源](arm_cortex_x2_figures/10_ooo_resource_comparison.jpg)
...
![图 11：X2、A710 与 Zen 4 的 FP/Vector 吞吐](arm_cortex_x2_figures/11_fp_vector_throughput.jpg)
...
![图 12：X2 与 Zen 4 的 FP/Vector 调度](arm_cortex_x2_figures/12_fp_vector_scheduler.jpg)
...
![图 13：Cortex-X2 标量 Store-to-Load Forwarding](arm_cortex_x2_figures/13_x2_scalar_store_forwarding.png)
...
![图 14：Zen 4 标量 Store-to-Load Forwarding](arm_cortex_x2_figures/14_zen4_scalar_store_forwarding.png)
...
![图 15：X2 的向量 Store Forwarding](arm_cortex_x2_figures/15_x2_vector_store_forwarding.png)

*图 15：测试使用 `str q,[x]` 与 `ldr d,[x]`。除两个 64-bit 半部外，低 32-bit 合并路径形成额外快区；其余部分重叠仍进入慢路。*

![图 16：Zen 4 的向量 Store Forwarding](arm_cortex_x2_figures/16_zen4_vector_store_forwarding.png)
...
![图 17：X2、A710 与 Zen 4 的地址转换](arm_cortex_x2_figures/17_address_translation.png)
...
![图 18：Snapdragon 8+ Gen 1 的 X2 延迟层级](arm_cortex_x2_figures/18_x2_cache_latency.png)
...
![图 19：DSU-110 的 Slice 与双环](arm_cortex_x2_figures/19_dsu110_structure.png)
...
![图 20：DSU-110 的可配置 L3 数据流水线](arm_cortex_x2_figures/20_dsu110_l3_pipeline.png)
...
![图 21：X2 与 Apple M1 的 Cache/Memory 延迟](arm_cortex_x2_figures/21_cache_memory_latency_comparison.png)
...
![图 22：X2、M1 与 N1/Ampere Altra 的向量 Read 带宽](arm_cortex_x2_figures/22_vector_read_bandwidth.png)
...
![图 23：X2、Skylake 与 Zen 4 的 Read 带宽](arm_cortex_x2_figures/23_cache_memory_read_bandwidth.png)
...
![图 24：X2 的 Read 与 Streaming Write 带宽](arm_cortex_x2_figures/24_cache_memory_write_bandwidth.png)
...
![图 25：Arm 给出的 Cortex-X2 面积与性能定位](arm_cortex_x2_figures/25_cortex_x2_area_slide.jpg)
...
![图 26：X2 到 X4 继续扩大的 TLB 与 L2](arm_cortex_x2_figures/26_x2_x4_tlb_l2_comparison.jpg)
