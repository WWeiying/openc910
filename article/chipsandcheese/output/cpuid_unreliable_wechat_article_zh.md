...
![图 2：把 47 字符空间写成玩笑名称，说明 Brand String 本身只是可编程数据](cpuid_unreliable_figures/02_figure.png)

## CPU-Z 为什么仍能识别 Zen 4，却显示错误名称

![图 3：改写前的 CPU-Z 识别结果](cpuid_unreliable_figures/03_figure.jpg)

![图 4：改写 Brand String 后，CPU-Z 仍识别 AMD/Zen 4 特征，但型号名称已经变化](cpuid_unreliable_figures/04_figure.jpg)
...
![图 5：被改写身份后的 Geekbench 5 系统信息与单核结果](cpuid_unreliable_figures/05_figure.png)

![图 6：另一张看似合理的 Geekbench 5 结果；性能本身没有提示 Brand String 被改](cpuid_unreliable_figures/06_figure.png)
...
![图 7：标准 CPUID 叶子提供的处理器标识信息](cpuid_unreliable_figures/07_figure.jpg)
