# Grace Hopper：Nvidia 的“半融合”CPU/GPU 超级芯片
...
![图 1：Grace Hopper GH200](nvidia_grace_hopper_figures/01_gh200_render.jpg)
...
![图 2：Grace CPU 的 SCF Mesh](nvidia_grace_hopper_figures/02_scf_mesh.jpg)
...
![图 3：Grace CPU 的 Core-to-core Latency](nvidia_grace_hopper_figures/03_core_to_core_latency.png)
...
![图 4：Kaby Lake-G 的双内存池思路](nvidia_grace_hopper_figures/04_kaby_lake_g.png)
...
![图 5：Grace、Hopper 与 NVLink C2C](nvidia_grace_hopper_figures/05_grace_hopper_architecture.png)
...
![图 6：CPU 访问本地 LPDDR 与远端 HBM 的带宽](nvidia_grace_hopper_figures/06_cpu_remote_memory_bandwidth.png)
...
![图 7：Grace CPU 的本地与远端内存延迟](nvidia_grace_hopper_figures/07_cpu_memory_latency.png)
...
![图 8：不同离散 GPU 的 CPU→VRAM 延迟](nvidia_grace_hopper_figures/08_vulkan_uplink_latency.png)
...
![图 9：Grace 与 Graviton 4 的 Neoverse V2 实现](nvidia_grace_hopper_figures/09_neoverse_v2_implementations.jpg)
...
![图 10：Grace、Graviton 4 的 Cache/Memory 周期](nvidia_grace_hopper_figures/10_cache_latency_cycles.png)
...
![图 11：按纳秒比较 Cache/Memory 延迟](nvidia_grace_hopper_figures/11_cache_latency_time.png)
...
![图 12：单核 Cache/Memory 带宽](nvidia_grace_hopper_figures/12_single_core_bandwidth.png)
...
![图 13：全核 L1/L2 带宽](nvidia_grace_hopper_figures/13_all_core_private_cache_bandwidth.png)
...
![图 14：共享数组下的全芯片 L3 带宽](nvidia_grace_hopper_figures/14_shared_array_l3_bandwidth.png)
...
![图 15：Grace 与 Graviton 4 的 libx264](nvidia_grace_hopper_figures/15_libx264_performance.png)
...
![图 16：Grace 与 Graviton 4 的 7-Zip](nvidia_grace_hopper_figures/16_7zip_performance.png)
...
![图 17：libx264 的 Memory Backend Stall](nvidia_grace_hopper_figures/17_libx264_backend_stalls.png)
...
![图 18：7-Zip 的 Memory Backend Stall](nvidia_grace_hopper_figures/18_7zip_backend_stalls.png)
...
![图 19：GH200 H100 的 Cache/VRAM 延迟](nvidia_grace_hopper_figures/19_h100_memory_latency.png)
...
![图 20：GH200 H100 的 GPU Memory Bandwidth](nvidia_grace_hopper_figures/20_h100_memory_bandwidth.png)
...
![图 21：GH200 测试触发的 Kernel/Graphics 错误](nvidia_grace_hopper_figures/21_kernel_errors.png)
...
![图 22：Arm 评估 Neoverse V2 的仿真平台](nvidia_grace_hopper_figures/22_arm_v2_evaluation_platform.png)
