...
![图 1：参与测试的处理器之一](amd_zen5_variants_figures/01_figure.jpg)

![图 2：把上限继续降到 3.5、1 GHz 对 Redwood Cove IPC 的影响](amd_zen5_variants_figures/02_figure.png)
...
![图 3：各平台与实际频率配置](amd_zen5_variants_figures/03_figure.jpg)
...
![图 4：3 GHz 上限下的 libx264 性能](amd_zen5_variants_figures/04_figure.png)
...
![图 5：3 GHz 上限下的 7-Zip 压缩](amd_zen5_variants_figures/05_figure.png)
...
![图 7：AMD 各代 ISA 扩展支持](amd_zen5_variants_figures/07_figure.png)
...
![图 11：libx264 分支预测表现](amd_zen5_variants_figures/11_figure.png)
...
![图 14：内核编译的指令 Cache 未命中](amd_zen5_variants_figures/14_figure.png)
...
![图 15：各架构计数器口径示意](amd_zen5_variants_figures/15_figure.jpg)

![图 16：libx264 的前端/后端限制](amd_zen5_variants_figures/16_figure.png)
...
![图 17：7-Zip 的流水线限制](amd_zen5_variants_figures/17_figure.png)

内核编译则明显前端受限。降低频率能减少后端以周期计的内存等待，却不能消除分支与指令 Cache 问题。Zen 5 仍然是图中最快的核心，只是 8-wide 后端让“未被喂满的潜在槽位”看起来更多。

![图 18：内核编译的流水线限制](amd_zen5_variants_figures/18_figure.png)

## 六、真正跨越十代的限制没有改变

![图 19：另一颗参与测试的处理器](amd_zen5_variants_figures/19_figure.jpg)
...
![图 20：DDR3 内存条](amd_zen5_variants_figures/20_figure.jpg)
