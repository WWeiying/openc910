...
![图 1：Amlogic S922X 的 DDR4；乱序执行用于隐藏这类内存延迟](cortex_a73_reordering_capacity_figures/01_figure.jpg)
...
![图 2：顺序退休、精确异常与错误路径清除](cortex_a73_reordering_capacity_figures/02_figure.png)
...
![图 3：未决 Branch 阻塞后测得约 40 个整数结果寄存器](cortex_a73_reordering_capacity_figures/03_figure.png)
...
![图 4：A57、A72、A73 的推测性资源容量](cortex_a73_reordering_capacity_figures/04_figure.png)
...
![图 5：A72 与 A73 寄存器文件和执行端口关系](cortex_a73_reordering_capacity_figures/05_figure.png)
...
![图 6：Store 与 Branch 共享约 11 项容量的测量](cortex_a73_reordering_capacity_figures/06_figure.png)
...
![图 7：NOP 测试没有找到有限 ROB 容量](cortex_a73_reordering_capacity_figures/07_figure.png)
...
![图 8：测试 Cortex-A73 的单板机](cortex_a73_reordering_capacity_figures/08_figure.jpg)

当工作负载真要依赖这些结构时，A73 常比 A72/A57 吃亏。libx264 中，它能以更小资源接近 A57；文件压缩则不是如此。

![图 9：A73 在不同负载中的 IPC 对照](cortex_a73_reordering_capacity_figures/09_figure.png)

IPC 不是全部。S922X 的四个 A73 可被动散热持续 2.2 GHz，Tegra X1 的四个 A57 即使主动散热也只有 1.8 GHz。

![图 10：折入频率后的实际性能非常接近](cortex_a73_reordering_capacity_figures/10_figure.png)
