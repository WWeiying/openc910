# AMD Zen 4 下篇：Load/Store、Cache、TLB 与 DDR5
...
![图 1：Zen 4 Load/Store 子系统的行为复原](amd_zen4_part2_figures/01_zen4_load_store_subsystem.png)
...
![图 2：Zen 4 Store-to-Load Forwarding 矩阵](amd_zen4_part2_figures/02_store_forwarding_matrix.png)
...
![图 3：各代核心的 Store Forwarding 情形汇总](amd_zen4_part2_figures/03_store_forwarding_summary.jpg)
...
![图 4：未对齐 Store、Load 与跨页访问所需的内部工作](amd_zen4_part2_figures/04_misaligned_access_paths.png)
...
![图 5：未对齐访问的倒数吞吐](amd_zen4_part2_figures/05_misaligned_access_throughput.jpg)
...
![图 6：2 MB 页下的 Cache/内存周期延迟](amd_zen4_part2_figures/06_cache_latency_cycles_2mb_pages.png)
...
![图 7：2 MB 页下的真实纳秒延迟](amd_zen4_part2_figures/07_cache_latency_ns_2mb_pages.png)
...
![图 8：Zen 4 与 Zen 3 V-Cache 的容量—延迟取舍](amd_zen4_part2_figures/08_zen4_vcache_latency.png)
...
![图 9：4 KB 页下的 Cache、TLB 与 Page Walk 延迟](amd_zen4_part2_figures/09_cache_latency_4kb_pages.png)
...
![图 10：单核 Cache 与 DRAM 读取带宽](amd_zen4_part2_figures/10_single_core_cache_bandwidth.png)
...
![图 11：用 Little’s Law 估算 L2 miss 跟踪深度](amd_zen4_part2_figures/11_l2_miss_queue_estimate.jpg)
...
![图 12：多线程 Cache 与内存带宽](amd_zen4_part2_figures/12_multicore_cache_bandwidth.png)
...
![图 13：双 CCD 与 I/O Die 的链路拓扑](amd_zen4_part2_figures/13_zen4_ccd_iod_topology.jpg)
...
![图 14：不同访问模式的 DRAM 带宽](amd_zen4_part2_figures/14_dram_access_patterns.png)
...
![图 15：Zen 4 与 Zen 2 的代际升级路径](amd_zen4_part2_figures/15_zen_generation_summary.jpg)
...
![图 16：libx264 中的 Zen 2 FP/向量端口利用率](amd_zen4_part2_figures/16_fp_pipe_utilization.png)

*图 16：FP0～FP3 平均利用约 27.06%、20.21%、27.81%、15.52%。正式图注指出执行单元即便在尖峰也不是瓶颈，FP 调度器很少因满而停；真正出现后端停顿的是 ROB 与整数寄存器。*

![图 17：一个周期窗口中的前端宽度利用率](amd_zen4_part2_figures/17_frontend_width_utilization.png)
