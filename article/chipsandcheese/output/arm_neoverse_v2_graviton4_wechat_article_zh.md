# Arm Neoverse V2：走进 AWS Graviton 4
...
![图 1：AWS Graviton 4 封装](arm_neoverse_v2_graviton4_figures/01_graviton4_package.jpg)
...
![图 2：单路 Graviton 4 的核间延迟](arm_neoverse_v2_graviton4_figures/02_single_socket_core_latency.png)
...
![图 3：双路 Graviton 4 的核间延迟](arm_neoverse_v2_graviton4_figures/03_dual_socket_core_latency.png)
...
![图 4：跨 Socket 内存延迟](arm_neoverse_v2_graviton4_figures/04_cross_socket_memory_latency.png)
...
![图 5：本地与远端 NUMA 内存带宽](arm_neoverse_v2_graviton4_figures/05_numa_memory_bandwidth.png)
...
![图 6：Neoverse V2 微架构总览](arm_neoverse_v2_graviton4_figures/06_neoverse_v2_overview.jpg)
...
![图 7：Neoverse V2 的方向模式识别](arm_neoverse_v2_graviton4_figures/07_v2_branch_pattern.png)
...
![图 8：Zen 4 的方向模式识别](arm_neoverse_v2_graviton4_figures/08_zen4_branch_pattern.png)
...
![图 9：V2 的 Taken Branch 足迹与延迟](arm_neoverse_v2_graviton4_figures/09_v2_btb_latency.png)

*图 9：随静态 Taken Branch 数增加出现多个延迟台阶，据此估计 256/8K/14K 三层。容量与层级均来自拐点反推，冲突和代码布局会使台阶偏离真实 Entry 数。*

![图 10：V2、Golden Cove 与 Zen 4 的目标缓存覆盖](arm_neoverse_v2_graviton4_figures/10_btb_comparison.png)
...
![图 11：Neoverse V2 的间接目标预测](arm_neoverse_v2_graviton4_figures/11_v2_indirect_targets.png)
...
![图 12：调用深度与返回预测](arm_neoverse_v2_graviton4_figures/12_return_stack.png)
...
![图 13：V2 与 Zen 4 的指令供给带宽](arm_neoverse_v2_graviton4_figures/13_instruction_fetch_bandwidth.png)
...
![图 14：Move Elimination 与清零 Idiom](arm_neoverse_v2_graviton4_figures/14_rename_behavior.png)
...
![图 15：V2、Zen 4 与 Oryon 的整数集群](arm_neoverse_v2_graviton4_figures/15_integer_cluster_comparison.png)
...
![图 17：FP 与向量执行延迟](arm_neoverse_v2_graviton4_figures/17_fp_vector_latency.jpg)
...
![图 18：Neoverse V2 的 Store-to-Load Forwarding](arm_neoverse_v2_graviton4_figures/18_v2_store_forwarding.png)
...
![图 19：Zen 4 的 Store-to-Load Forwarding](arm_neoverse_v2_graviton4_figures/19_zen4_store_forwarding.png)
...
![图 20：以周期表示的 Cache 与内存延迟](arm_neoverse_v2_graviton4_figures/20_cache_memory_latency_ns.png)
...
![图 21：以纳秒表示的 Cache 与内存延迟](arm_neoverse_v2_graviton4_figures/21_cache_memory_latency_cycles.png)
...
![图 22：单线程 Cache 与内存带宽](arm_neoverse_v2_graviton4_figures/22_single_thread_cache_bandwidth.png)
...
![图 23：单颗处理器的全核 Cache 带宽](arm_neoverse_v2_graviton4_figures/23_full_chip_cache_bandwidth.png)
...
![图 24：八核 Benchmark 性能](arm_neoverse_v2_graviton4_figures/24_benchmark_performance.png)
...
![图 25：libx264 与 7-Zip 的每线程 IPC](arm_neoverse_v2_graviton4_figures/25_benchmark_ipc.png)
...
![图 26：两项工作负载的分支预测正确率](arm_neoverse_v2_graviton4_figures/26_branch_prediction_accuracy.png)
...
![图 27：libx264 与 7-Zip 的 Branch MPKI](arm_neoverse_v2_graviton4_figures/27_branch_mpki.png)
...
![图 28：前端与后端受限比例](arm_neoverse_v2_graviton4_figures/28_frontend_backend_bound.png)
...
![图 29：Neoverse V2 与 Zen 4c 的核心面积](arm_neoverse_v2_graviton4_figures/29_v2_zen4c_area.jpg)
...
![图 30：AWS 发布 Graviton 4 时的产品定位](arm_neoverse_v2_graviton4_figures/30_graviton4_launch.jpg)
