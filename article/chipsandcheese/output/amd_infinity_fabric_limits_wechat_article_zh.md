# 把 AMD Infinity Fabric 推到极限：带宽、排队与“吵闹邻居”
...
![图 1：AmpereOne 的 Loaded Latency 曲线](amd_infinity_fabric_limits_figures/01_figure.jpg)
...
![图 2：Zen 2 的 IFOP 物理接口](amd_infinity_fabric_limits_figures/02_figure.png)

*图 2：来自 AMD ISSCC 2020。接口尺寸与结构是公开图示。*

![图 3：多级争用点示意](amd_infinity_fabric_limits_figures/03_figure.png)
...
![图 4：7950X3D 的双 CCD 拓扑](amd_infinity_fabric_limits_figures/04_figure.jpg)
...
![图 5：同一 Zen 4 CCD 内的 Loaded Latency](amd_infinity_fabric_limits_figures/05_figure.jpg)
...
![图 6：跨 CCD 隔离后的 Zen 4 曲线](amd_infinity_fabric_limits_figures/06_figure.jpg)
...
![图 7：交替加载两颗 CCD 的带宽与延迟](amd_infinity_fabric_limits_figures/07_figure.jpg)

*图 7：少量线程时总带宽高、延迟仍受控。*

![图 8：高线程数时的延迟失控](amd_infinity_fabric_limits_figures/08_figure.jpg)
...
![图 9：Zen 4 PPR 的 Xi Sampled Latency 事件](amd_infinity_fabric_limits_figures/09_figure.jpg)

*图 9：官方定义事件，但“Xi”的展开并未公开。*

文章推测 Xi 是 L3 Complex 的 External Interface，并以 Queue Entry 占用时长采样。

![图 10：Zen 1 L3 Complex 中的 Xi](amd_infinity_fabric_limits_figures/10_figure.jpg)
...
![图 11：软件延迟与 Xi 延迟的范围差异](amd_infinity_fabric_limits_figures/11_figure.jpg)

*图 11：二者不能直接当作同一指标。*

![图 12：全系统测试中的两 CCD Xi 延迟](amd_infinity_fabric_limits_figures/12_figure.jpg)
...
![图 13：Zen 5 测试平台](amd_infinity_fabric_limits_figures/13_figure.jpg)

*图 13：高速内存使单 CCD IFOP 只覆盖 DRAM 理论带宽约 55%，而 Zen 4 测试平台约 71.4%。*

![图 14：Zen 5 同 CCD Loaded Latency](amd_infinity_fabric_limits_figures/14_figure.jpg)

*图 14：CCX 内争用仍增大延迟，但比 Zen 4 温和，基础延迟也因高速 DRAM 更低。*

Hot Chips 2024 图示 Zen 5 每 CCX 有两个 Xi，并暗示更多 Queue Entry。

![图 15：Zen 5 的双 Xi 组织](amd_infinity_fabric_limits_figures/15_figure.jpg)

*图 15：更多入口可降低一个带宽线程独占队列的概率；具体分配仍未由 RTL 确认。*

跨 CCD 时，Zen 4 的单线程尖峰消失。因为两代使用同一 I/O Die，除了 CCD 结构，AMD 也可能调整了 Fabric 公平性政策。

![图 16：Zen 5 跨 CCD 隔离](amd_infinity_fabric_limits_figures/16_figure.jpg)

*图 16：更快 FCLK/DRAM 与可能的调度变化共同作用，不能只归因于一个因素。*

![图 17：Zen 5 双 CCD 超过 100 GB/s 时的延迟](amd_infinity_fabric_limits_figures/17_figure.jpg)
...
![图 18：Zen 2 的双 CCX/CCD 拓扑](amd_infinity_fabric_limits_figures/18_figure.jpg)
...
![图 19：Zen 2 的 CCX 内与跨 CCX 对照](amd_infinity_fabric_limits_figures/19_figure.jpg)
...
![图 20：三代 Zen 单核 DRAM 带宽](amd_infinity_fabric_limits_figures/20_figure.jpg)

*图 20：后代单核更强，也使公平调度更重要。*

![图 21：Zen 2 的跨 CCD 隔离](amd_infinity_fabric_limits_figures/21_figure.jpg)

*图 21：单带宽线程没有 Zen 4 异常尖峰，可能只是它不足以占满队列，而非高级 QoS。*

![图 22：3950X 与 7950X3D 跨 CCD 延迟](amd_infinity_fabric_limits_figures/22_figure.jpg)

*图 22：旧 DDR4 控制器即使更接近带宽极限，仍能较好控制延迟。*

![图 23：两条 IFOP 同时工作时的 Zen 2](amd_infinity_fabric_limits_figures/23_figure.jpg)
...
![图 24：Zen 2 PPR 的 Xi 延迟事件](amd_infinity_fabric_limits_figures/24_figure.jpg)

*图 24：事件按周期累加 Queue Occupancy。*

![图 25：Zen 2 平均 Xi Queue Occupancy](amd_infinity_fabric_limits_figures/25_figure.jpg)

*图 25：平均约 59～61，接近 64，可能意味着每 CCX 64 项、每 CCD 128 项；计数器不支持 Count Mask，故不能把近似反推写成确定容量。*

![图 26：Zen 3 的 192 个 Pending Miss](amd_infinity_fabric_limits_figures/26_figure.jpg)

*图 26：AMD Hot Chips 33 明确给出的八核 CCX 数字。*

![图 27：Zen 5 可能的 320 项 Xi 容量](amd_infinity_fabric_limits_figures/27_figure.png)
...
![图 28：Cyberpunk 在两 CCD 上的 L3 miss 流量与延迟](amd_infinity_fabric_limits_figures/28_figure.jpg)

*图 28：V-Cache 降低 miss 流量和排队延迟，帧率从 122.34 到 153.98 FPS，提升 25.8%；两种情况都未逼近 IFOP/DRAM 峰值，基础延迟与命中率更重要。*

![图 29：GHPC 的 L3 miss 与延迟](amd_infinity_fabric_limits_figures/29_figure.jpg)

*图 29：趋势相同但流量更低，V-Cache 的次级收益是减轻 L3 之后所有层级的排队。*

![图 30：Baldur’s Gate 3 的带宽与 Xi 延迟](amd_infinity_fabric_limits_figures/30_figure.jpg)
...
![图 31：RawTherapee 的突发带宽与延迟](amd_infinity_fabric_limits_figures/31_figure.jpg)

*图 31：流量尖峰未必持续满 1 s，但采样延迟超过 200 ns，表明队列在短时间内被推满。*

![图 32：玩 Baldur’s Gate 3 同时后台转码](amd_infinity_fabric_limits_figures/32_figure.jpg)

*图 32：L3 miss 流量不低但延迟受控，游戏多数时间保持 60 FPS。*

![图 33：加入 L3 Hit 后的总片上带宽](amd_infinity_fabric_limits_figures/33_figure.jpg)

*图 33：部分采样超过 85 GB/s；大 L3 把大量流量留在片上。假想 16 核、每核 1 MB L2、无 L3 的 Zen 4 会严重冲击 Fabric/DDR，但现实中并无这一配置。*

![图 34：多级互连的“吵闹邻居”](amd_infinity_fabric_limits_figures/34_figure.jpg)

*图 34：一个层级的多个 Source 汇聚到下一层 Choke Point，队列满会让延迟敏感任务受牵连。*

![图 35：三代 Zen Loaded Latency 总览](amd_infinity_fabric_limits_figures/35_figure.jpg)
