...
![图 1：NVIDIA Olympus 核心结构](nvidia_vera_figures/01_figure.png)
...
![图 2：NVIDIA 对传统 SMT 与 Spatial Multithreading 的对比](nvidia_vera_figures/02_figure.jpg)
...
![图 3：静态五加五与逐周期动态选择的简化示意](nvidia_vera_figures/03_figure.png)
...
![图 4：Pentium 4 的 SMT 流水线示意](nvidia_vera_figures/04_figure.jpg)
...
![图 5：AMD Zen 5 的 SMT 资源共享方式](nvidia_vera_figures/05_figure.jpg)
...
![图 6：Vera 与 x86 NUMA 的白皮书对比](nvidia_vera_figures/06_figure.jpg)
...
![图 7：Turin 与 Vera 的核间延迟热图](nvidia_vera_figures/07_figure.jpg)
...
![图 8：白皮书选择的四项 SPEC CPU2026 结果](nvidia_vera_figures/08_figure.png)
...
![图 9：Vera 的 SPEC CPU2026 整数 Rate 估算明细](nvidia_vera_figures/09_figure.jpg)

*图 9：表中列出 13 个子项、352 copies 和总估算 925。完整套件与精选子集回答的是不同问题：前者更接近总体吞吐，后者只说明特定编译/解释类代码很适合 Olympus。*

![图 10：白皮书论证与实际可支持结论的对应](nvidia_vera_figures/10_figure.png)
...
![图 11：满载 Socket 下的所谓单线程 IPC](nvidia_vera_figures/11_figure.png)
...
![图 12：Vera 与 Turin 的前后端计数器对比](nvidia_vera_figures/12_figure.png)
...
![图 13：Vera 与 Turin 的带宽—延迟曲线](nvidia_vera_figures/13_figure.jpg)
...
![图 14：AMD 第六代 EPYC 的内存接口升级](nvidia_vera_figures/14_figure.jpg)
...
![图 15：PageRank 核数扩展](nvidia_vera_figures/15_figure.png)
...
![图 16：白皮书的强化学习训练信号图](nvidia_vera_figures/16_figure.png)
