# 龙芯 LSX 与 LASX：LoongArch 的 128/256-bit 向量扩展
...
![图 1：F、VR、XR 的别名关系](loongson_lsx_lasx_figures/01_figure.png)
...
![图 2：由 Toolchain/Disassembly 猜测的 LSX/LASX 编码](loongson_lsx_lasx_figures/02_figure.png)
...
![图 3：128-bit 运算对 XR 高半部的影响](loongson_lsx_lasx_figures/03_figure.png)
...
![图 4：部分 Load 后回存完整 XR 的结果](loongson_lsx_lasx_figures/04_figure.png)
...
![图 5：VLD 对高 128 bit 的未定义影响](loongson_lsx_lasx_figures/05_figure.png)
...
![图 6：3A5000 的初步乱序资源测量](loongson_lsx_lasx_figures/06_figure.png)
...
![图 7：3A5000 Vector/FP 执行布局](loongson_lsx_lasx_figures/07_figure.png)
...
![图 8：3A5000 与 Zen 1/Skylake Vector 性能](loongson_lsx_lasx_figures/08_figure.jpg)
