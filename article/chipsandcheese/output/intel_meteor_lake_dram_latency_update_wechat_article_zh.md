...
![图 1：Meteor Lake 内存速率、Gear 与低功耗状态](intel_meteor_lake_dram_latency_update_figures/01_figure.png)
...
![图 2：不同发起核心与附加带宽负载下的 DRAM 延迟](intel_meteor_lake_dram_latency_update_figures/02_figure.png)
