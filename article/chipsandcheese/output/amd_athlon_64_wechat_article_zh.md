# Athlon 64：AMD 如何靠“把基础做对”击败 NetBurst
...
![图 1：AMD K8 微架构总览](amd_athlon_64_figures/01_k8_overview.png)
...
![图 2：Intel NetBurst 微架构总览](amd_athlon_64_figures/02_netburst_overview.png)
...
![图 3：K8 Die 上的分支预测区域](amd_athlon_64_figures/03_k8_die_branch_predictor.jpg)
...
![图 4：K8 的随机分支模式识别](amd_athlon_64_figures/04_k8_branch_pattern.png)

*图 4：随着 Pattern Length 与活跃 Branch 数增加，K8 的低延迟区域较早破裂。曲面混合 History、Capacity 和 Aliasing，不能仅凭形状确认 Hash。*

![图 5：NetBurst 的随机分支模式识别](amd_athlon_64_figures/05_netburst_branch_pattern.jpg)
...
![图 6：K8 的 BTB 容量与 Branch Spacing](amd_athlon_64_figures/06_k8_btb_capacity.png)
...
![图 7：NetBurst 的 Branch Target 容量](amd_athlon_64_figures/07_netburst_btb_capacity.png)
...
![图 8：K8 Die 上的 Frontend](amd_athlon_64_figures/08_k8_die_frontend.jpg)
...
![图 9：K8 L1I 与 NetBurst Trace Cache 的有效覆盖](amd_athlon_64_figures/09_instruction_cache_capacity.png)
...
![图 10：8-byte Instruction 下的前端 Byte Bandwidth](amd_athlon_64_figures/10_long_instruction_fetch.png)
...
![图 11：Zeroing Idiom 的依赖消除](amd_athlon_64_figures/11_zero_idiom.jpg)
...
![图 12：K8 Die 上的执行与寄存器区域](amd_athlon_64_figures/12_k8_die_execution.jpg)
...
![图 13：K8 与 NetBurst 的重排序资源](amd_athlon_64_figures/13_reorder_capacity.png)
...
![图 14：K8 Integer Execution Unit](amd_athlon_64_figures/14_integer_execution.png)
...
![图 15：K8 的 FP Scheduler 与执行资源](amd_athlon_64_figures/15_fp_scheduler.png)
...
![图 16：K8 FPU 结构](amd_athlon_64_figures/16_fp_execution.png)
...
![图 17：K8 Die 上的 Load/Store 区域](amd_athlon_64_figures/17_k8_die_lsu.jpg)
...
![图 18：Athlon 64 的 Store-to-load Forwarding](amd_athlon_64_figures/18_k8_store_forwarding.png)

*图 18：成功约五周期；Failed Forwarding 多为十周期，跨 8 B Boundary 时约十五周期。非重叠访问跨 8 B 也会降吞吐。网页正式图注强调：检查基础，但回退代价适中。*

![图 19：NetBurst 的 Store Forwarding](amd_athlon_64_figures/19_netburst_store_forwarding.png)
...
![图 20：K8 两级 Unified Memory Queue](amd_athlon_64_figures/20_memory_queue.png)
...
![图 21：K8 与 NetBurst 的 Cache/Memory 绝对延迟](amd_athlon_64_figures/21_cache_latency_time.png)

*图 21：上半按纳秒展示，K8 的 L1/L2/DRAM 路径都很短；具体平台与 Memory Timing 不同。*

![图 22：相同结果按周期表示](amd_athlon_64_figures/22_cache_latency_cycles.png)
...
![图 23：AMD Hot Chips 14 的 K8 Cache 资料](amd_athlon_64_figures/23_k8_hot_chips_cache.png)
...
![图 24：4 KB Page 下的 TLB/Memory 延迟](amd_athlon_64_figures/24_tlb_memory_latency.png)
...
![图 25：K8 与 NetBurst 的 Cache 读取带宽](amd_athlon_64_figures/25_cache_read_bandwidth.png)
...
![图 26：双核/多线程 DRAM 读取带宽](amd_athlon_64_figures/26_multicore_dram_bandwidth.png)
...
![图 27：K8 与 NetBurst 的写带宽](amd_athlon_64_figures/27_write_bandwidth.png)

*图 27：L1 范围内 AMD 大幅领先，Intel 在 L2 略胜，DRAM 又落后。Write Policy 直接改变“L1 写峰值”的含义。*

### 一致性延迟

![图 28：K8 双核与 NetBurst 的核间延迟](amd_athlon_64_figures/28_core_to_core_latency.png)
...
![图 29：K8 与 NetBurst 的主要优劣](amd_athlon_64_figures/29_k8_netburst_summary.jpg)
...
![图 30：Athlon 64 K8 Die](amd_athlon_64_figures/30_k8_die_final.jpg)
