...
themeName: "学术论文 (副本)"
title: "pezy_sc4s_hot_chips_2025_wechat_article_zh"
---
...
![图 1：PEZY-SC4s 的众核计算定位](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/94493fdc9c5046be_01_figure.jpg)
...
![图 2：SC3、SC3s 与 SC4s 规格对比](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/066fec35bd8ba300_02_figure.jpg)
...
![图 3：八线程 PE 与两组四线程](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/432282bbe3f39acb_03_figure.png)

短停顿由细粒度轮换覆盖；长延迟事件可用线程切换指令或 Load 等指令的标志切到另一组，也可启用从 SC2 继承的自动 `chgthread`。

![图 4：长延迟触发粗粒度线程组切换](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/c8e97a2de06d5dfe_04_figure.png)
...
![图 5：MIMD、小 SIMD 与 GPU 宽 Wave 的比较](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/f370c10de11f2db5_05_figure.png)
...
![图 6：PE、Village、City 与指令缓存层级](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/27c710318969792c_06_figure.png)
...
![图 7：4 KB L1D 的容量、带宽与延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/fd6dab860296c8c2_07_figure.jpg)
...
![图 8：PE 私有/共享本地存储](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/5e1756853f8017ba_08_figure.jpg)
...
![图 9：City、Crossbar 与 64 MB L3](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/0e39781b80dffdf7_09_figure.jpg)

L3 还执行原子操作。PEZY 用显式同步/Flush 指令让各层写入可见，而不是构建 CPU 式硬件缓存一致性，从而简化硬件，但把正确同步责任交给编程模型。

![图 10：缓存层级、原子操作和显式同步](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/1eb41f669455a1e0_10_figure.jpg)
...
![图 11：PEZY 各代管理处理器演进](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/172346c72218f68c_11_figure.png)

主机接口升级为 PCIe 5.0 x16。计划系统使用 Zen 5 EPYC 9555P、InfiniBand，并让一台主机挂四颗 SC4s；上一代四卡系统使用 Zen 2 EPYC 7702P。

![图 12：单主机四加速卡的 SC4s 系统](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/439dd1e979dfc17b_12_figure.jpg)

![图 13：上一代 PEZY-SC3 主机配置](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/2902d9b824966d7b_13_figure.jpg)

## 能效目标与适用场景

PZCL 编程模型类似 OpenCL，小向量减少分歧损失，多级缓存兼顾容量与速度。

![图 14：PZCL 软件与应用模型](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/80868ef5062bb8e1_14_figure.jpg)

早期资料给出整芯片 270 W、DGEMM 时 PE 部分约 212 W，但 Hot Chips 时尚无硅片，PEZY 没有发布最终功耗。

![图 15：PEZY-SC 路线图与早期功耗目标](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/0b5f2e46e043c378_15_figure.png)
...
![图 16：SC4s 的 FP64 峰值能效比较](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/pezy_sc4s_hot_chips_2025_wechat_article_zh/c8321d18e940bbbe_16_figure.jpg)
