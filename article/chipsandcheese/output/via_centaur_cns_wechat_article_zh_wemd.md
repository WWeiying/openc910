...
themeName: "学术论文 (副本)"
title: "via_centaur_cns_wechat_article_zh"
---
...
![图 1：Centaur 公布的 CNS 核心与集成 NCore AI 加速器的 CHA 芯片](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/85329cf10d7b95f7_01_figure.png)

2021 年末，Intel 收购 Centaur 设计团队的消息传出。Centaur 当时是 Intel、AMD 之外仅存的高性能 x86 设计团队，这笔交易很可能让 CNS 的独立产品化戛然而止。

![图 2：从 Centaur 清仓拍卖取得的 CHA 工程样片](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/1ad6e68256661b07_02_figure.jpg)
...
![图 3：CHA 芯片布局，资料来自 Centaur 在 Linley Spring Processor Conference 的演讲](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/c4ead977981c735c_03_figure.jpg)

由于公开环境中找不到 NCore 驱动，测试集中在 CNS CPU 核心。图 4 是根据微基准观察整理的结构总览，其中带问号或近似号的容量属于反推，不应理解为官方模块参数。

![图 4：根据测试整理的 CNS 微体系结构概览](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/d541f9b61d809b64_04_figure.png)
...
![图 5：CNS 在不同分支数量与重复模式长度下的方向预测表现](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/1906c4a0972ffbbe_05_figure.png)

![图 6：Haswell 的同类方向预测测试](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/db7c18cb5778fdf7_06_figure.png)
...
![图 7：每条间接分支拥有多个目标时的容量测试](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/9db0e083cc139cdb_07_figure.png)

![图 8：间接分支轮换多个目标时，每条分支增加的时间](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/b894f4c086742dda_08_figure.png)
...
![图 9：不同活动分支数量下的目标预测速度](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/500920b5051dde6e_09_figure.png)
...
![图 10：分支间距为 16 字节时，CNS、Haswell 等核心的目标预测对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/b29aae1a8e4dcd8a_10_figure.png)
...
![图 11：用 8 字节 NOP 测试 L1I 带宽，这种长度更接近带前缀的向量指令](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/9ee242b4bc7b6a77_11_figure.png)

![图 12：用 4 字节 NOP 测试更接近普通非向量代码的取指与译码吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/10ff3b563624f370_12_figure.png)
...
![图 13：代码规模变化时的前端指令吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/6a872c05b80ff6ed_13_figure.png)
...
![图 14：CNS 与 Haswell 的乱序执行资源对照，数值来自微基准反推](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/659c9dbe2037f9f0_14_figure.jpg)
...
![图 15：CNS 的整数执行端口与功能分布](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/7c3bab5d1b0f4440_15_figure.png)
...
![图 16：CNS 的向量与浮点执行管线](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/a29f9dc385fc4cb4_16_figure.png)
...
![图 17：CNS 的地址生成吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/2496f1e51b1a94a7_17_figure.png)
...
![图 18：CNS 的 Store Forwarding 矩阵；纵轴为 64-bit Store 偏移，横轴为 32-bit Load 偏移](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/2bb93366edc748ef_18_figure.png)

代价在于延迟偏高，尤其是转发失败时。Load 与 Store 仅部分重叠会把延迟推到 21 周期；Load 跨越 64 字节 Cache Line 时，成功转发增加 1 周期；既跨线又转发失败，还会多付出 6 周期。

![图 19：Haswell 的 Store Forwarding 矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/bcc35621b29a46e4_19_figure.png)
...
![图 20：CNS、Haswell 与 Skylake 的 Cache 参数；Haswell 为 E5-2690 v3，Skylake 为 Azure Xeon 8171M](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/df46a4bb8072c0a6_20_figure.jpg)

整体上，CNS 的 Cache 延迟高于服务器平台上的 Haswell。频率差异解释了一部分：CNS 为 2.2 GHz，对照 Haswell 约为 3 GHz。

![图 21：Cache 与内存延迟，左侧为绝对时间，右侧为核心周期](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/8c2f5e84c3d61449_21_figure.png)
...
![图 22：使用 2 MB 大页后的绝对访问延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/34eb8bba69586dc0_22_figure.png)

![图 23：使用 2 MB 大页后的周期延迟；图 22 为时间，图 23 为周期](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/169a66ef1d36ab07_23_figure.png)
...
![图 24：单核各级存储层次的绝对带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/0f253f2043c57261_24_figure.png)

![图 25：单核各级存储层次的每周期字节数；图 24 为绝对带宽，图 25 为 B/cycle](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/5413b3b0ada0a8b8_25_figure.png)

从 L1 到 L2，读带宽几乎不下降，保持在略低于 64 B/cycle。

![图 26：L2 区域的绝对带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/941a6ee1cce86d08_26_figure.png)

![图 27：L2 区域的每周期字节数；图 26 为绝对带宽，图 27 为 B/cycle](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/0ca5301542deae93_27_figure.png)

即使 Intel 后续核心也很难持续提供这样的 L2 读取能力，CNS 在这里表现十分抢眼；进入 L3 后，带宽则显著下降。

![图 28：8 核并发时的总带宽；拷贝带宽当时仍在完善测试能力，因此可信度低于读取结果](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/a597e23c0a4baabe_28_figure.png)
...
![图 29：被测 CHA 服务器的 lstopo 拓扑](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/b0d1cef8e3d8b8c2_29_figure.png)
...
![图 30：CNS 与 Haswell-E 的多核 L3 带宽扩展](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/3370969675fa6df6_30_figure.png)
...
![图 31：核心数量增加时的 DRAM 带宽扩展](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/307b8d627a5c6c70_31_figure.png)
...
![图 32：4 KB 对齐 Cache Line 的核间一致性延迟分布；该地址似乎最接近 Core 7](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/71411989345126f7_32_figure.png)

考虑 CNS 的低频，其锁操作延迟并不差，Haswell-E 大致处于同一范围。Intel 一方面受益于更高频率，另一方面为了连接更多核心和 Cache 使用了双环，跨越更多 hop 通常会增加延迟。

![图 33：Intel 双环拓扑下的核间延迟对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/b0ff5be88fc4d39d_33_figure.png)
...
![图 34：CNS 与多代 Intel 核心的近似面积对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/d78bc8b9e87cdff8_34_figure.jpg)
...
![图 35：工艺差距扩大后，CNS 相对 Zen 2 等核心的面积与性能位置](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/via_centaur_cns_wechat_article_zh/d085ca2ee0e043a4_35_figure.png)
...
第二，**同一代际标签掩盖了实现差异**。CNS 可以达到“Haswell-Class”IPC目标，却通过不同的 BTB、循环结构、向量端口和寄存器复用来实现。相似性能不等于相同微体系结构。
