...
themeName: "学术论文 (副本)"
title: "cinebench2024_review_wechat_article_zh"
---
...
![图 1：Cinebench 2024 运行在 IBM Cloud 四路 Cascade Lake 虚拟机上](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/b690870581f70610_01_figure.jpg)
...
![图 2：Cinebench 2024 动态指令扩展分布](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/c14d226b05c144d3_02_figure.png)
...
![图 3：最常执行的 43 条指令；FP 以标量为主，128 bit 位于长尾](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/75c5afc6986f479e_03_figure.png)
...
![图 4：动态指令长度分布；8 Byte 以上很少](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/dd8662f35916a2de_04_figure.png)

![图 5：Load、Store、Branch 与其他操作比例](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/d1300f5d577d3596_05_figure.png)
...
![图 6：Zen 4、Zen 2 与 Kaby Lake 的 Top-down 吞吐归因](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/d6d0c530eccbc466_06_figure.png)
...
![图 7：Cinebench 2024 的分支预测准确率与 MPKI](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/a319ab44762aec96_07_figure.png)

Zen 4 准确率最高，却可能损失更多 Wrong-path Slot：更快的前端和更大的后端窗口会在发现误预测前带入更多错误指令。也就是说，核心其他部分越强，残余误预测的浪费反而越大。

![图 8：以 1 秒窗口观察 IPC 与预测准确率，三者呈正相关](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/570ee4eccaf422c3_08_figure.png)

预测不只要准，还要尽早给出 Target。Zen 4 很少发生 L2 BTB Override，据此估计 Hot Branch Footprint 小于 1536 项，Taken Branch 很少承担额外 3 Cycle Pause。

![图 9：各核心 BTB 层级命中与 Redirect；Skylake 只能以 BAClear 表示 BTB Miss](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/eeb094c8c97915c4_09_figure.png)
...
![图 10：Zen 2 的三级 BTB 供给分布](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/32c77750a99b4579_10_figure.png)

![图 11：把 BTB 容量与 Override/Miss 对照；未控制组相联度、替换策略和更新延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/6c900d13735220d1_11_figure.png)
...
![图 12：三种核心的 Micro-op 来源](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/6608fd330c6b0a13_12_figure.png)
...
![图 13：各级 Instruction Cache 请求；Zen 2 为何产生更多 L2 Code Fetch 尚不确定](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/5419e0b7eca94b41_13_figure.png)

核心能以高吞吐从 L2 取代码，但功耗并非没有代价：L2 偏密度、访问能耗高于 L1，约每 17～25 Cycle 就有一次 Code Fetch。

![图 14：Ryzen 7950X3D 的 L2 流量；命中带宽可超过 350 GB/s](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/fddc6c56b6a54f60_14_figure.png)

把数据访问算入后，L2 大约每 10 Cycle 收到一次请求。

![图 15：前端损失结构；没有出现游戏中超过 30%的 Frontend Latency Slot](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/552421129d5bcbb8_15_figure.png)
...
![图 16：Zen 4 后端结构满载情况](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/d3fc7cf4d6a22d4e_16_figure.png)

![图 17：Zen 2 后端结构满载情况](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/21310d92b4b80d9d_17_figure.png)
...
![图 18：Kaby Lake 后端 Stall，Unified Scheduler 最突出](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/35fa75e40c149b7e_18_figure.png)
...
![图 19：Zen 4 六条 FP Pipe 的任务分布；该 Event 在 Rename 阶段计数](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/0bb59f22bdccbdd2_19_figure.png)

Zen 4 的加法、乘法 Pipe 承担主力，两条 FP Store Pipe 很轻，更适合看成“Store 卸载后的增强四管线”。Zen 2 的 FP2 同时做 Add 与 Write，负载最高但刚过 30%，并未饱和。

![图 20：Zen 2 四条 FP Pipe 利用率](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/9354a3953cb92838_20_figure.png)

![图 21：Kaby Lake 全部执行 Port 利用率；Port 0/1 共享 Integer 与 FP](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/1a156b706c25af93_21_figure.png)
...
![图 22：三种核心的内存相关流水槽位损失](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/0a062db52fc9ea75_22_figure.png)

数据访问比游戏规则得多：L1D 偶尔 Miss，L2 捕获绝大部分；但一旦穿过 L2，继续穿过 L3 的概率不低。

![图 23：数据 Cache 命中率；Intel 与 AMD 的事件定义不同，不能只看柱高](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/6d4abad889006930_23_figure.png)

与 R15/R23 相比，2024 的 Data Footprint 更大、DRAM Traffic 更高。单核 LLC Miss 仍低于游戏，但所有核心同时运行会把带宽需求相乘。

![图 24：AMD 16 核平台的 L3 Miss Bandwidth 约 20 GB/s](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/55255fa77bd07dc7_24_figure.png)
...
![图 25：三平台 DRAM Access Latency；测量位置不同，绝对值不可直接比较](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/ac7580fd6cb87df6_25_figure.png)

![图 26：Zen 2 的 1 秒窗口中，排队请求增加时带宽近线性增长，尚未触及带宽墙](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/a8958c6f0fe69757_26_figure.png)
...
![图 27：AMD FP Pipe Assignment 的事件语义与 Zen 4 AVX-512 特例](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/cinebench2024_review_wechat_article_zh/797e097bf68c8c8c_27_figure.png)
