...
themeName: "学术论文 (副本)"
title: "intel_goldmont_plus_wechat_article_zh"
---
...
![图 1：Intel 对 Gemini Lake 平台的渲染图，CPU core 采用 Goldmont Plus](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/f43e807989c878a6_01_figure.png)
...
![图 2：Goldmont Plus 前端、分布式 scheduler、执行端口、共享 4 MB L2 的整体框图](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/fb261eaedeb29616_02_figure.png)
...
![图 3：Celeron J4125 的分支模式识别测试，随 pattern length 与 branch count 变化](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/52b0a58efa1cddb8_03_figure.png)

目标预测做了更明显的取舍。GLP 主 BTB 约 2048 项、命中路径 3 周期。容量与 Nehalem、Core 2 接近，速度却更慢：Core 2 主 BTB 约 2 周期，还能让最多四条分支走 1 周期快速路径。

![图 4：Goldmont Plus 的 branch target tracking，约 2048 branch 后惩罚明显上升](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/aaf4c59255f7e987_04_figure.png)

![图 5：GLP 与 Core 2、Haswell 的目标缓存速度；Haswell 可让约 128 条分支走 1 周期路径](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/8cdc9b88904c5f40_05_figure.png)
...
![图 6：Goldmont Plus 的间接目标预测，横轴为每条分支的 target 数和 branch 数](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/80b876e56668d0c9_06_figure.png)
...
![图 7：8-byte NOP 测得的 instruction fetch bandwidth，GLP 在 L1I 内约 16 B/cycle](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/65206ad3ce0a502b_07_figure.png)
...
![图 8：每条 NOP 4 byte 时，GLP 与 Cortex-A72 的取指/执行 IPC 随代码 footprint 变化](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/1183ca614c92301b_08_figure.png)
...
![图 9：Goldmont Plus 识别的 zeroing idiom 与 move-elimination 测试结果](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/44cf52c7af4341be_09_figure.jpg)
...
![图 10：GLP 的 PRF 方案与 Core 2 ROB/retired-register-file 方案对比](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/58814dea15e857bf_10_figure.png)
...
![图 11：Goldmont Plus、Silvermont 与 AMD Zen 的整数 scheduler/port 对比](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/649fd66ea6c25840_11_figure.png)
...
![图 12：Goldmont Plus、Silvermont 与 Zen 的 FP scheduler/pipe 布局](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/d1f3f814ef2ebba6_12_figure.png)
...
![图 13：Goldmont Plus、Silvermont 与 Zen 的 AGU 配置](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/e2ac3dbd60e4822b_13_figure.png)
...
![图 14：用 Henry Wong 方法测得的 GLP store-to-load forwarding 矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/17cbed0cb98a4074_14_figure.png)
...
![图 15：Skylake 的转发矩阵；包含式 load 和跨 cache line 情况明显更强](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/2195d47cfa3ea917_15_figure.png)
...
![图 16：GLP 与 AMD Zen 的 iTLB/dTLB、共享 L2 TLB 容量对比](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/eebd23fe075b7ad9_16_figure.png)
...
![图 17：2 MB page 测得的 GLP cache/memory latency；dTLB 不支持 2 MB page，128 KB 后翻译延迟影响 L2 台阶](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/7d7debacd9bf5f26_17_figure.png)
...
![图 18：J4125、Core 2 Extreme、Graviton 1/A72 与 Skylake 的 cache 容量和延迟对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/76f6da00e9bc689e_18_figure.jpg)

Core 2 同样是两级 cache 的高性能设计，其 L2 既足够大可作 LLC，又足够快可直接承接 L1 miss。

![图 19：GLP 四核共享一块 4 MB L2，而 Core 2 Quad 是两个双核 cluster 各有 4 MB L2](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/251dd172acb4c212_19_figure.png)
...
![图 20：单线程读取带宽；GLP L1D 约 16 B/cycle、L2 约 8 B/cycle](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/e113305b31ed4d13_20_figure.png)

表现接近十年前的 Core 2，远落后 Skylake。Skylake 可在更高频率下每周期两条 32-byte load，单核从 L3 获得的带宽甚至可高于 GLP 从 L1D 获得的带宽。

![图 21：单线程写带宽；GLP 在 4 KB 后出现异常下降](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/2193f5f5cd8adc85_21_figure.png)
...
![图 22：写入 footprint 扩大后，L2/LLC store 计数上升，支持 4 KB write-back buffer 的推断](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/8f7231e2eef1e39e_22_figure.png)
...
![图 23：四线程 cache/DRAM 带宽；GLP 的 L2 扩展尚可，DDR4 读取仅约 7700K 一半](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/1ae91e3d8c1717a3_23_figure.png)
...
![图 24：Celeron J4125 与 Core i5-6600K 的逐核原子 ping-pong 延迟矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_goldmont_plus_wechat_article_zh/7964dc23707a1adc_24_figure.png)
