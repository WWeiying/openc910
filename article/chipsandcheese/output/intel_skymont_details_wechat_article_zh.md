...
![图 1：Intel 对 Skymont 的总体介绍](intel_skymont_details_figures/01_figure.jpg)
...
![图 2：Skymont 三集群前端](intel_skymont_details_figures/02_figure.png)
...
![图 3：Skymont 的两 Cache Line 分支扫描](intel_skymont_details_figures/03_figure.png)
...
![图 4：传统 Atom 的共享微码路径](intel_skymont_details_figures/04_figure.jpg)

Skymont 把 Gather 等最常见复杂指令的微码复制到每个 Cluster，Intel 称之为 Nanocode。三组可以独立处理这些指令；罕见复杂指令仍可能走共享 Microcode ROM，以控制容量。

![图 5：三集群 Nanocode](intel_skymont_details_figures/05_figure.png)

![图 6：Skymont 与大核复杂译码策略对照](intel_skymont_details_figures/06_figure.png)
...
![图 7：Skymont 后端宽度与资源](intel_skymont_details_figures/07_figure.jpg)
...
![图 8：重命名数据依赖与宽退休](intel_skymont_details_figures/08_figure.jpg)
...
![图 9：Skymont 的 26 端口执行后端](intel_skymont_details_figures/09_figure.png)
...
![图 10：Skymont FP/向量执行](intel_skymont_details_figures/10_figure.jpg)

![图 11：Skymont 四条 128-bit 向量路径](intel_skymont_details_figures/11_figure.png)
...
![图 12：最小 Normal 值乘 0.5 的 Subnormal 测试](intel_skymont_details_figures/12_figure.jpg)
...
![图 13：Skymont Cache 带宽](intel_skymont_details_figures/13_figure.jpg)
...
![图 14：Skymont 的集群内一致性改进](intel_skymont_details_figures/14_figure.png)
...
![图 15：Skymont 产品与核心](intel_skymont_details_figures/15_figure.jpg)
