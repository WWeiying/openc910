...
![图 1：Odroid N2+ 单板机](arm_cortex_a73_figures/01_odroid_n2_plus.jpg)
...
![图 2：Cortex-A73 核心总览](arm_cortex_a73_figures/02_cortex_a73_overview.png)
...
![图 3：Cortex-A72 结构对照](arm_cortex_a73_figures/03_cortex_a72_overview.png)
...
![图 4：Cortex-A73 的方向模式识别](arm_cortex_a73_figures/04_a73_branch_pattern.png)

*图 4：同时扫描 Pattern Length 和分支数量。A73 无法像高功耗核心那样处理大量分支与超长模式，但低延迟区域不算小；台阶之后同时混入历史不足、容量和混叠。*

![图 5：Cortex-A57 的方向模式识别](arm_cortex_a73_figures/05_a57_branch_pattern.png)
...
![图 6：A73 的 BTB 延迟与容量](arm_cortex_a73_figures/06_a73_btb_latency_capacity.png)

*图 6：曲线改变 Branch Spacing。约 48 个分支之前是较快层，主层约 3 周期；代码足迹超过 L1I 后出现大台阶。3072 项是行为推测，不能直接写成官方容量。*

![图 7：A57 的 BTB 对照](arm_cortex_a73_figures/07_a57_btb_latency_capacity.png)
...
![图 8：A73 的间接分支预测](arm_cortex_a73_figures/08_a73_indirect_targets.png)
...
![图 9：A73 与 A57 的返回预测](arm_cortex_a73_figures/09_return_stack_a73_a57.png)
...
![图 10：A73 与 A72 的指令取数带宽](arm_cortex_a73_figures/10_instruction_fetch_bandwidth.png)
...
![图 11：A73 与 A72 的重命名行为](arm_cortex_a73_figures/11_rename_move_elimination.png)
...
![图 12：A73 的后端资源停顿](arm_cortex_a73_figures/12_backend_resource_stalls.png)
...
![图 13：A73 与 A72 的整数和访存调度](arm_cortex_a73_figures/13_scheduler_a73_a72.png)
...
![图 14：A73 与 A72 的 FPU Scheduler](arm_cortex_a73_figures/14_fpu_scheduler_a73_a72.png)
...
![图 15：A73 与 Zen 2 的地址转换层级](arm_cortex_a73_figures/15_address_translation_a73_zen2.png)
...
![图 16：A73 与 Zen 2 二级 TLB 的映射存储成本](arm_cortex_a73_figures/16_tlb_storage_cost.jpg)
...
![图 17：A73 的 Store-to-Load Forwarding](arm_cortex_a73_figures/17_a73_store_forwarding.png)
...
![图 18：A72 的 Store-to-Load Forwarding](arm_cortex_a73_figures/18_a72_store_forwarding.png)
...
![图 19：A73 与 A72 的 Cache/Memory 延迟](arm_cortex_a73_figures/19_cache_memory_latency.png)
...
![图 21：四核 Cache 与内存带宽](arm_cortex_a73_figures/21_multithread_cache_bandwidth.png)
...
![图 22：共享 L2 配置与实测对照](arm_cortex_a73_figures/22_l2_cache_comparison.jpg)
...
![图 23：S922X 的核间延迟](arm_cortex_a73_figures/23_core_to_core_latency.png)
...
![图 24：S922X DDR 接口](arm_cortex_a73_figures/24_s922x_ddr_interface.png)
...
![图 25：1 GB 工作集的多线程 Read 带宽](arm_cortex_a73_figures/25_memory_bandwidth_comparison.png)
...
![图 26：2 MB 页、1 GB 工作集的内存延迟](arm_cortex_a73_figures/26_memory_latency_comparison.png)
...
![图 27：A57 与 A73 的实际负载](arm_cortex_a73_figures/27_a57_a73_application_performance.png)
