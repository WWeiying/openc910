...
themeName: "学术论文 (副本)"
title: "spec_cpu2026_evaluation_wechat_article_zh"
---
...
![图 1：SPEC CPU2026 工作负载与源代码规模](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/a338aae7800bbf20_01_figure.jpg)
...
![图 2：CPU2026 与历代 Reference System](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/d746e2ccdafd235a_02_figure.png)
...
![图 3：Zen 5 与 Lion Cove 的总分](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/5dd929c9a1e07d53_03_figure.png)

最新 Desktop 整数接近，Zen 5 浮点领先。Lion Cove 只跑 5.5 GHz，因为两颗可到 5.7 GHz 的 Core 在套件中 Crash；Sample 可能异常，稳定 5.7 GHz 应缩小差距。

![图 4：整数子项与 eMAG/FX-8350 参照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/7086357ba90d84f8_04_figure.png)

现代核心尤其在 `706.stockfish` 彻底超过 eMAG，连十多年前 FX-8350 在几乎所有项都更合适作参照。

![图 5：浮点子项 Score](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/f62b7f50b4bb4cff_05_figure.png)

Zen 5 的部分优势来自 GCC 生成 AVX-512。Intel SDE 只统计每项最后一次 Invocation，以节省时间；若一个 Binary 用多组 Input，多次行为并未全部覆盖。

![图 6：最后一次 Invocation 的 Vector Instruction Mix](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/040b40dd544617f9_06_figure.png)
...
![图 7：整数 IPC 分布](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/e8724babf0ad4759_07_figure.png)

CPU2026 Integer 在 Zen 5/Lion Cove 上更高、更集中，接近 Geekbench 6。

![图 8：浮点 IPC 分布](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/320b7be345823808_08_figure.png)
...
![图 10：浮点 Workload 的 IPC 与 Memory 压力](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/4491d2256ee02ac5_10_figure.jpg)
...
![图 11：CPU2026 Integer 的 Top-down 分解](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/ba5065f49e0d6249_11_figure.png)
...
![图 12：CPU2017 FP Top-down](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/ed35103d0f971ab5_12_figure.png)

![图 13：CPU2026 FP Top-down](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/f8fbd403b81d102b_13_figure.png)

FP 继续以 Core Throughput 为主，Branch 少且可预测。`fotonik3d/roms` 在两核上严重 Backend Memory-bound，多数其他为 Core-bound。

![图 14：709.cactus 在 Zen 5/Lion Cove 的不同瓶颈](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/cf9f970325f36eaa_14_figure.png)
...
![图 15：CPU2017 Integer Branch MPKI](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/4d80d7ef1d7cdaa4_15_figure.png)
...
![图 18：CPU2026 FP Branch MPKI](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/4caab0a480169591_18_figure.png)
...
![图 21：Lion Cove Integer Instruction Hierarchy](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/cb416331a128a72a_21_figure.jpg)

小 Loop 用 Loop Stream Detector 锁住 192 项 Micro-op Queue，Integer 中主要是 `750.sealcrypto`。

![图 22：Lion Cove Integer LSD Coverage](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/b8dcf2ff6472fe09_22_figure.png)
...
![图 23：Zen 5 FP Frontend Coverage](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/7b6f8caa6df4e82e_23_figure.png)

Lion Cove FP 多项在 Tiny Loop；`722.palm` 由 192 项 Queue 覆盖 40% 以上，出 Loop 后又很可能同时 Miss Op Cache 与 64 KB L1I。

![图 24：Lion Cove FP LSD 与 Code Miss](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/cdcc097b0f259620_24_figure.jpg)
...
![图 25：Zen 5 Integer Data Cache MPKI](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/4ac3a651e0f2b574_25_figure.png)
...
![图 26：Lion Cove Integer L1.5/L2/L3 Behavior](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/13b44d360ab48b39_26_figure.png)

FP 中 `709.cactus` 刺穿 48 KB L1D，AMD L2/L3 处理良好；只有 `765.roms`、`749.fotonik3d` 有明显 LLC Miss。

![图 27：Zen 5 FP Data Cache MPKI](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/f310dbb6df21dd58_27_figure.png)

Intel L3 MPKI 较低却不完全可比：Counter 只算 Retired Load，忽略被 Flush 的 Load；两家也只把对某 64 B Line 发起首次 Refill 的 Miss 计一次。

![图 28：Lion Cove FP LLC Miss 与 Fill Buffer Hit](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/spec_cpu2026_evaluation_wechat_article_zh/4c5ff6630a17dd79_28_figure.png)
