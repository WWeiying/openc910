...
themeName: "学术论文 (副本)"
title: "intel_gracemont_wechat_article_zh"
---
...
![图 1：Gracemont 微架构总览](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/b8bb1f952002cbb8_01_gracemont_block_diagram.png)
...
![图 2：Gracemont 的方向预测曲面](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/f0b96b7d689ac5c5_02_gracemont_pattern_surface.jpg)

*图 2：Pattern Length 超过约 1K 后，每分支时间温和上升，支持存在较慢 Override Predictor。低延迟区域已超过 Skylake。*

![图 3：Golden Cove 的方向预测曲面](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/0e8337a0a6a9fe5c_03_golden_cove_pattern_surface.png)

*图 3：Golden Cove 为追求峰值性能，把复杂预测结果也尽量做快；Gracemont 在速度与功耗间更平衡。*

![图 4：Gracemont 与 Zen 2 的历史长度对比](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/0e12ea116fc934c3_04_gracemont_zen2_history.jpg)

*图 4：两者可追踪相近长历史；Gracemont 一级预测器更强，长历史时较少等待二级覆盖。*

![图 5：Gracemont 与 Zen 2 的容量/历史对比](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/0e8337a0a6a9fe5c_05_gracemont_zen2_pattern.png)
...
![图 6：A78 与 Gracemont 的历史长度](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/89d376efeeaae016_06_a78_history.jpg)

*图 6：A78 使用非 Override 路线，也能覆盖较长历史，但上限低于 Gracemont。*

![图 7：A78 的方向预测曲面](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/0e8337a0a6a9fe5c_07_a78_pattern.png)
...
![图 8：不同核心的 BTB 延迟（周期）](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/eaf92aaeabe80f44_08_btb_latency_cycles.jpg)

*图 8：Gracemont 与 Zen 3 都能在约 1024 个分支内零气泡预测；Gracemont 二级 BTB 增加约两周期，Zen 3 约三周期。*

![图 9：不同核心的 BTB 延迟（纳秒）](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/e1dad21dc77fd3f3_09_btb_latency_ns.jpg)
...
![图 10：压缩负载的分支准确率](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/a4341cc62ebb5cbf_10_compression_branch_accuracy.png)

*图 10：压缩中 Intel 核心相对 AMD 表现不占优，Gracemont 没有因为大结构自动获胜。*

![图 11：libx264 的分支准确率](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/bfdcc770f11044f3_11_x264_branch_accuracy.png)

*图 11：编码负载同样显示工作负载相关性；准确率与 MPKI 还受每千指令分支数量影响。*

![图 12：Geekbench 4 整数子项的分支准确率](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/12902d182a8b7f12_12_geekbench_branch_accuracy.png)
...
![图 13：Gracemont 的双 Cluster 前端](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/3de18119a56208de_13_clustered_frontend.png)
...
![图 14：循环长度与 Decode 吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/e3a5aca914903f1a_14_decode_loop_length.jpg)
...
![图 15：Gracemont 的指令字节带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/ca9227fce4e46695_15_fetch_bytes_bandwidth.jpg)
...
![图 16：libx264 中的指令长度](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/9edc91c7bf857124_16_avx_instruction_length.png)

*图 16：Intel SDE 模拟 Haswell 级 ISA（含 AVX2、不含 AVX-512），展示编码负载中长指令占比；8 B NOP 是压力上界，不是平均代码。*

![图 17：四字节 NOP 下的 Decode IPC](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/8059029182509480_17_decode_ipc.jpg)
...
![图 18：Haswell 各部分功耗构成](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/5efa0142b213813b_18_l1i_power_figure.jpg)
...
![图 19：Gracemont 的 Rename 优化](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/66f80ff8b0cc6379_19_rename_optimization.jpg)
...
![图 20：Gracemont、Golden Cove 与 Zen 的乱序容量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/b29f163b090e5ba6_20_ooo_capacity.jpg)
...
![图 21：libx264 的向量寄存器压力](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/88eb51fe0a1c2af3_21_x264_vector_register_pressure.jpg)
...
![图 22：Gracemont 的整数 Scheduler](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/6e8f0bb8f55dcafc_22_integer_scheduler.png)
...
![图 24：FP/Vector 操作延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/ae51e0c8317b9d35_24_fp_vector_latency.jpg)
...
![图 25：Gracemont 的访存调度结构](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/1a5262e26987a8e5_25_memory_scheduler.png)
...
![图 26：把 Atom Cluster 接到 Alder Lake Ring](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/98e3039f9fcb0301_26_atom_cluster_with_l3.png)

*图 26：每四颗 Gracemont 共用一个 Ring Stop 和 L2，概念上就是“Atom Cluster + 桌面 L3”；大核则每核有私有 L2 和独立 Ring Stop。*

### 延迟

![图 27：Cache/内存延迟（纳秒）](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/e38226b51a0ce48f_27_cache_latency_ns.jpg)

*图 27：Gracemont 3-cycle L1D 即使频率低，也比 Golden Cove 5-cycle 更快返回；大多数数据访问命中 L1，这不到四分之一纳秒的优势有实际价值。*

![图 28：Cache/内存延迟（周期）](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/427602a5b4c7bc5b_28_cache_latency_cycles.jpg)

*图 28：2 MB 内共享 L2 以容量换速度；进入 L3 后承受与 Golden Cove 相同的高延迟，换算周期数也接近。*

![图 29：以 Little’s Law 估算窗口能覆盖的 Demand Access](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/c2b2834ee8f68d17_29_littles_law_window.jpg)
...
![图 30：Cinebench R15 的 L2 Hitrate 示例](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/8d85143f769dc4e9_30_l2_effect_example.png)
...
![图 31：Gracemont 的 TLB 容量与延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/813af4f6896b3b27_31_tlb_latency.jpg)
...
![图 32：Gracemont 与高性能核心的单核带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/ab3eeaa3fb24ac3b_32_single_core_bandwidth.jpg)

*图 32：高频、256-bit 大核在 L1/L3 占优；Gracemont 的 64 B/cycle L2 接口可把多数带宽动态给单核。DDR4 反而高于 DDR5，支持高 DDR5 延迟和保守预取限制单核并发。*

![图 33：与 128-bit 数据通路核心比较](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/9736750c3612e478_33_128bit_core_bandwidth.jpg)

*图 33：Gracemont L2 几乎追平 L1，接近 Zen 1 的相对表现；L3 带宽仍明显较低。*

单核带宽适合分析结构，却未必代表吞吐应用；高度向量化负载通常也会多线程。

![图 34：四核 Cluster 的带宽扩展](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/5c329907b9087806_34_cluster_bandwidth.jpg)

*图 34：四核同时访问后，共享 L2 接口使每核约低于 16 B/cycle，Zen 1 凭每核私有 L2 胜出；L3 扩展也较差。*

![图 35：Gracemont Cluster 与 Zen CCX 的 L2](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/6cd79feeaba24a07_35_shared_l2_topology.png)
...
![图 36：八颗 Gracemont 的总带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/8482ee5cb9292e53_36_eight_ecore_bandwidth.jpg)
...
![图 37：Gracemont 与 Golden Cove 的设计取舍](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/bb4595c9b0b86952_37_golden_gracemont_comparison.jpg)
...
![图 38：Gracemont、Golden Cove 与 Zen 2 的编码功耗](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/afa88aa27d623b00_38_x264_power.jpg)
...
![图 39：单类与混合整数操作的调度容量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/d2dac9cc520157e4_39_integer_scheduler_tests.jpg)
...
![图 40：Jump 与 Add/Multiply 混合测试](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/6b9c8a04d106d0ba_40_jump_mix_scheduler.jpg)
...
![图 41：Scheduler 与 NSQ 的区分方法](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/12b3717e97d1f8db_41_nsq_test_method.jpg)

*图 41：独立指令可先离开 Scheduler，为随后依赖指令腾位；台阶取决于真正可 Wakeup/Select 的窗口，而非总在途数量。*

![图 42：Gracemont FP Add 的 Scheduler/NSQ 结果](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/71f8730d4ae87834_42_scheduler_nsq_result.png)
...
![图 43：最初的独立 Load Scheduler 解释](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/a30db6bebf016844_43_initial_memory_scheduler.jpg)

*图 43：依赖 Load 构造下的台阶支持约 40 项，但测量路径可能先撞上其他 Load 相关资源。*

改用链式整数除法阻塞退休后，同类容量测试表明 Load 与 Store Port 共享 Scheduler。

![图 44：修订后的 Load/Store 共享 Scheduler 证据](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_gracemont_wechat_article_zh/1ba06b93a8e21991_44_revised_shared_memory_scheduler.jpg)
