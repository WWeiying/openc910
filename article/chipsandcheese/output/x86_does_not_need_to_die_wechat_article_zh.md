...
![图 1：AMD Zen 4 微架构，依据 AMD 图示与微基准整理](x86_does_not_need_to_die_figures/01_figure.png)

![图 2：Arm Cortex-X2 微架构，主要由微基准推断](x86_does_not_need_to_die_figures/02_figure.jpg)
...
![图 3：LoongArch LASX Vector Extension 的部分观测编码](x86_does_not_need_to_die_figures/03_figure.png)
...
![图 4：视频编码中的 Block SAD 计算](x86_does_not_need_to_die_figures/04_figure.png)
...
![图 5：把 SAD 拆成简单操作后产生的大量重叠依赖与中间值](x86_does_not_need_to_die_figures/05_figure.png)
...
![图 6：Cortex-X2 Optimization Manual；RSUBHN2 可在两周期内完成 16 次 8 bit Subtract、选高半并 Round](x86_does_not_need_to_die_figures/06_figure.png)
...
![图 7：跨多代 PC 使用同一操作系统安装路径的兼容性示例](x86_does_not_need_to_die_figures/07_figure.png)
...
![图 8：LineageOS 拥有超过 1000 个 Repository，反映逐设备 Image 维护规模](x86_does_not_need_to_die_figures/08_figure.png)
...
![图 9：Intel Hot Chips 幻灯片中的 Itanium/EPIC 执行理念](x86_does_not_need_to_die_figures/09_figure.jpg)
