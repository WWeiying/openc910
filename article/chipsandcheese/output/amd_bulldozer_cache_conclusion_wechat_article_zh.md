# Bulldozer：AMD 的激进现代化（下）——Cache、内存与结局
...
![图 1：Bulldozer Cache Hierarchy](amd_bulldozer_cache_conclusion_figures/01_cache_hierarchy.jpg)
...
![图 2：Bulldozer、K10 与 Sandy Bridge 的 L1D Miss](amd_bulldozer_cache_conclusion_figures/02_l1d_miss_rate.png)
...
![图 3：L1D、WCC 与 L2 的写带宽](amd_bulldozer_cache_conclusion_figures/03_write_bandwidth.png)
...
![图 4：Bulldozer、K10 与 Sandy Bridge 的 Cache Latency](amd_bulldozer_cache_conclusion_figures/04_cache_latency.png)
...
![图 5：单/双线程 L2 带宽](amd_bulldozer_cache_conclusion_figures/05_l2_bandwidth.png)

*图 5：同 Module 两线程使 Bulldozer L2 Bandwidth 约翻倍，说明两套 LSU 有独立通路。*

![图 6：L2 到两颗 Core 的独立 Data Path](amd_bulldozer_cache_conclusion_figures/06_l2_datapaths.png)

*图 6：AMD 2011 IEEE 图显示两条各 16 B/cycle 的 L2→Core Path。网页正式图注说明来源。*

![图 7：双线程/多核 L2 带宽扩展](amd_bulldozer_cache_conclusion_figures/07_l2_dual_thread_bandwidth.png)
...
![图 8：Bulldozer 的 L3 Latency](amd_bulldozer_cache_conclusion_figures/08_l3_latency.png)
...
![图 9：Die 中央的 AMD Northbridge](amd_bulldozer_cache_conclusion_figures/09_northbridge_layout.jpg)
...
![图 10：集中 Northbridge 与 Ring-based L3](amd_bulldozer_cache_conclusion_figures/10_l3_interconnect.png)
...
![图 11：Westmere 与 Bulldozer 的 L3 Bandwidth](amd_bulldozer_cache_conclusion_figures/11_westmere_l3_bandwidth.png)
...
![图 12：Bulldozer 核间一致性延迟](amd_bulldozer_cache_conclusion_figures/12_core_to_core_latency.png)

*图 12：矩阵展示同 Module 与跨 Module 的明显分层。测试是 Contended Atomic Lock，不等价于所有 Read Sharing。*

![图 13：Core Transfer 发生频率](amd_bulldozer_cache_conclusion_figures/13_core_transfer_frequency.png)

*图 13：按 PMU 估计 Core-to-core Transfer，相对 L3 Miss 并不频繁。网页正式图注说明只看 Data Load，遗漏 Instruction Read Miss，因而可能低估 L3 Miss。*

![图 14：L3 Miss 与跨核事件的对照](amd_bulldozer_cache_conclusion_figures/14_l3_miss_frequency.png)
...
![图 15：双通道 DDR3 Memory Bandwidth 参照](amd_bulldozer_cache_conclusion_figures/15_memory_bandwidth.png)
...
![图 16：4 KB Page 下的有效访问延迟](amd_bulldozer_cache_conclusion_figures/16_4k_page_latency.png)
...
![图 17：AMD 对 Bulldozer 功耗组成的分析](amd_bulldozer_cache_conclusion_figures/17_power_breakdown.png)
...
![图 18：Bulldozer 到 Zen 的技术延续](amd_bulldozer_cache_conclusion_figures/18_bulldozer_to_zen.jpg)
...
![图 19：Bulldozer 系列测试平台](amd_bulldozer_cache_conclusion_figures/19_test_setup.jpg)
