...
![图 1：Arrow Lake 桌面处理器](intel_arrow_lake_system_figures/01_figure.jpg)
...
![图 2：Intel 早期多 Die 规划](intel_arrow_lake_system_figures/02_figure.jpg)
...
![图 3：Intel 与 AMD Chiplet 拓扑](intel_arrow_lake_system_figures/03_figure.png)

![图 4：Zen 5 CCD 的读与 Non-temporal Write 带宽](intel_arrow_lake_system_figures/04_figure.png)
...
![图 5：Foveros 与 FDI 规格](intel_arrow_lake_system_figures/05_figure.jpg)

![图 6：Compute Tile 到 SoC Tile 链路](intel_arrow_lake_system_figures/06_figure.jpg)

实际结果表明跨 Die 带宽不是瓶颈：读接近 DRAM 理论上限，写虽然略低，仍远高于 AMD 单 CCD，且没有写带宽减半。

![图 7：Arrow Lake DRAM 读写带宽](intel_arrow_lake_system_figures/07_figure.png)
...
![图 8：Arrow Lake、Raptor Lake 与 Zen 5 的 DRAM 延迟](intel_arrow_lake_system_figures/08_figure.jpg)

用带宽线程制造 Noisy Neighbor，再让另一线程做延迟测试：在约 60 GB/s 以前，Zen 5 的低基线延迟仍更快；超过这一点，AMD 单 CCD-to-IOD 链路开始拥塞，Arrow Lake 的宽 FDI 才体现优势。

![图 9：带宽负载下的 DRAM 延迟](intel_arrow_lake_system_figures/09_figure.png)
...
![图 10：Arrow Lake 核间延迟矩阵](intel_arrow_lake_system_figures/10_figure.jpg)
...
![图 11：BIOS 更新后的 Zen 5 核间延迟](intel_arrow_lake_system_figures/11_figure.jpg)
...
![图 12：Lion Cove 私有 Cache 与一致性路径](intel_arrow_lake_system_figures/12_figure.png)
...
![图 13：Arrow Lake 36 MB 分片 L3](intel_arrow_lake_system_figures/13_figure.jpg)

![图 14：P-Core 的 L1/L2/L3 延迟](intel_arrow_lake_system_figures/14_figure.png)

Zen 5 每个 CCX 有独立 32 MB L3，服务核心少，延迟很低；但单线程只能使用本 CCX 的 32 MB，即使 9900X 全芯片有 64 MB。Intel 统一 36 MB 更容易共享容量，却付出更长访问路径。

![图 15：Arrow Lake 与 Zen 5 Cache 延迟/容量](intel_arrow_lake_system_figures/15_figure.png)
...
![图 16：私有数组与共享数组的多核带宽方法](intel_arrow_lake_system_figures/16_figure.png)

为了降低 L2 命中干扰，测试让线程读取共享数据，可能在下游合并请求。Zen 5 的 L3 PMU 显示真实 L3 Hit 带宽与软件值接近，说明合并更可能发生在 L3 之后；Arrow Lake 当时尚无公开 PMU，无法同样验证。

![图 17：共享数组带宽的验证](intel_arrow_lake_system_figures/17_figure.png)
...
![图 18：多核 L3 带宽](intel_arrow_lake_system_figures/18_figure.png)

![图 19：Arrow Lake P/E-Core 与 Ring L3](intel_arrow_lake_system_figures/19_figure.jpg)
...
![图 20：Arrow Lake 与 Zen 5 的核心频率分布](intel_arrow_lake_system_figures/20_figure.png)

![图 21：Arrow Lake 多 Tile 封装](intel_arrow_lake_system_figures/21_figure.jpg)
