...
![图 1：Intel Arrow Lake 的 P-Core/E-Core 定位](intel_skymont_gaming_figures/01_figure.jpg)
...
![图 2：Skymont 游戏负载的 Top-Down 分类](intel_skymont_gaming_figures/02_figure.png)
...
![图 3：Skymont 的 Dispatch Stall 组成](intel_skymont_gaming_figures/03_figure.png)
...
![图 4：Cortex-X1 的分布式 Dispatch 约束示例](intel_skymont_gaming_figures/04_figure.png)
...
![图 5：游戏中的 Serialization 原因](intel_skymont_gaming_figures/05_figure.png)
...
![图 6：Crestmont 与 Skymont 的 Dispatch Stall](intel_skymont_gaming_figures/06_figure.png)
...
![图 7：三款游戏的 Cache Miss/千指令](intel_skymont_gaming_figures/07_figure.png)
...
![图 8：L2、L3 与 DRAM Memory Bound Cycle](intel_skymont_gaming_figures/08_figure.png)

*图 8：L2 Bound 很低，4 MB L2 和大窗口能隐藏大部分延迟；DRAM 占比最大，L3 居中。Skymont 较低频率也意味着相同纳秒延迟对应的潜在损失较少，这不是延迟本身变快。*

![图 9：每次 Memory Bound Stall 的平均持续时间](intel_skymont_gaming_figures/09_figure.png)
...
![图 10：Skymont Frontend Bound PMU Unit Mask](intel_skymont_gaming_figures/10_figure.png)

*图 10：表中列出 ITLB、L1I、BAClear、Branch Prediction、Predecode、Decode Stall 与 Microcode Sequencer 等类别。它展示事件定义，不代表每类都对游戏重要。*

![图 11：前端停顿的具体来源](intel_skymont_gaming_figures/11_figure.png)
...
![图 12：Cyberpunk 2077 平均帧率](intel_skymont_gaming_figures/12_figure.png)
...
5. 能稳定提供可玩性能，说明 Skymont 已是功能完整、性能不弱的核心；但要取代 P-Core，还需在更多单线程负载中达到或超过它。
