...
![图 1：AMD EPYC 9005 系列的 CCD 组织](amd_epyc_9355p_figures/01_figure.jpg)
...
![图 2：普通 GMI 与 GMI-Wide](amd_epyc_9355p_figures/02_figure.jpg)

*图 2：左侧 12-CCD 配置通常每颗 CCD 一条 GMI；右侧 8-CCD 配置每颗占用两个 GMI Port。双链路不是附带效果，而是这颗低核心数 SKU 的主要性能杠杆。*

![图 3：被测 Dell PowerEdge R6715](amd_epyc_9355p_figures/03_figure.jpg)
...
![图 4：9355P、桌面 Zen 5 与 Xeon 6 的 Cache/DRAM 延迟](amd_epyc_9355p_figures/04_figure.png)

*图 4：AMD 桌面与服务器复用 CCD，因此 L1/L2/L3 以 cycle 计接近；服务器频率更低、DRAM 路径更复杂。Intel 则从 L3 起采用不同的服务器组织。*

![图 5：三种 NPS 模式的本地与远端延迟](amd_epyc_9355p_figures/05_figure.jpg)
...
![图 6：NPS4 的核—内存延迟矩阵](amd_epyc_9355p_figures/06_figure.jpg)

*图 6：对角线是本地象限，非对角线是跨 IOD 请求。最坏空载值仍低于约 140 ns，说明大 IOD 内的跨区代价相对温和。*

![图 7：EPYC NPS4 与 Xeon 6 SNC3 的路径对照](amd_epyc_9355p_figures/07_figure.jpg)
...
![图 8：不同 NPS 模式的本地与跨节点总带宽](amd_epyc_9355p_figures/08_figure.jpg)
...
![图 9：单 CCD 纯读受载延迟](amd_epyc_9355p_figures/09_figure.png)
...
![图 10：单 CCD 1:1 读写的受载延迟](amd_epyc_9355p_figures/10_figure.png)
...
![图 11：Zen 4 桌面 IOD 与 Infinity Fabric 链路](amd_epyc_9355p_figures/11_figure.jpg)
...
![图 12：NPS4 单 CCD 的纯读与读写混合](amd_epyc_9355p_figures/12_figure.png)
...
![图 13：SPEC CPU2017 单线程估算](amd_epyc_9355p_figures/13_figure.png)
...
![图 14：四核、八 Copy 的 SPEC CPU2017 吞吐](amd_epyc_9355p_figures/14_figure.png)
...
![图 15：549.fotonik3d 八 Copy 结果](amd_epyc_9355p_figures/15_figure.png)
...
![图 16：AMD Zen 2 时代对统一 IOD 的延迟说明](amd_epyc_9355p_figures/16_figure.jpg)

*图 16：AMD 自 Zen 2 起把控制器集中到 IOD，以略高本地延迟换取更一致的 Socket 内访问。Turin 拓扑更复杂、DDR5 本身延迟更高，但设计主线延续。*

![图 17：EPYC 9005 的中央 IOD 与 CCD 封装](amd_epyc_9355p_figures/17_figure.jpg)
...
![图 18：机架中的 Dell PowerEdge R6715](amd_epyc_9355p_figures/18_figure.jpg)
