# AMD Zen 4 第三篇：Boost、Infinity Fabric 与 Raphael 核显
...
![图 1：逐核心 Boost 频率](amd_zen4_part3_figures/01_figure.png)
...
![图 3：第一颗 CCD 的短时 Boost 轨迹](amd_zen4_part3_figures/03_figure.png)

*图 3：仍以整数加法延迟估算频率，观察窗口约 700 ms。*

![图 4：第二颗 CCD 的短时 Boost 轨迹](amd_zen4_part3_figures/04_figure.png)
...
![图 5：线程扩展下的 DRAM 读取带宽](amd_zen4_part3_figures/05_figure.png)
...
![图 6：非临时写随核心数扩展](amd_zen4_part3_figures/06_figure.png)
...
![图 7：7950X 在 2 GHz FCLK 下的线程数—带宽关系](amd_zen4_part3_figures/07_figure.png)

*图 7：四线程取得最高值，继续增加独立流会让地址分布更散。*

![图 8：3950X 的对应扩展曲线](amd_zen4_part3_figures/08_figure.png)
...
![图 9：Zen 4 对理论 DRAM 带宽的利用率](amd_zen4_part3_figures/09_figure.png)

*图 9：每颗 CCD 两线程时约达到理论值 81%，是本测试的高效区。*

![图 10：Zen 2 的 DDR4 利用率](amd_zen4_part3_figures/10_figure.png)
...
![图 15：Host 与 GPU 之间的复制带宽](amd_zen4_part3_figures/15_figure.png)
