...
themeName: "学术论文 (副本)"
title: "intel_skymont_wechat_article_zh"
---
...
![图 1：Lunar Lake 中的 Skymont 效率核](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/c9f8d79ff2260b48_01_lunar_lake_package.jpg)
...
![图 2：Meteor Lake 与 Lunar Lake 的 E-Core 布局变化](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/efe490ae9941dbdf_02_meteor_lake_core_layout.jpg)
...
![图 3：Skymont 微架构总览](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/68f8e69e0ace6560_03_skymont_microarchitecture.jpg)
...
![图 4：Crestmont 微架构总览](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/74168812d5e8269d_04_crestmont_microarchitecture.jpg)
...
![图 5：Skymont 的随机方向模式识别](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/4d28bf79998cd8aa_05_direction_prediction_pattern.png)
...
![图 6：512 个分支下的历史模式容量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/7933d81b93abaf78_06_many_branch_history_pattern.png)
...
![图 7：Skymont BTB 容量与命中延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/5ff2d8ae78d2ab22_07_btb_capacity_latency.png)

*图 7：随着静态 Taken 分支数量增长，曲线出现多个延迟平台。前一级约 1024 项可实现无空泡 Taken 分支，落入后一级后延迟增至约 3～4 个周期；接近 8K 后再次明显恶化，据此得到末级 BTB 容量判断。*

![图 8：Crestmont BTB 的对应测试](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/85fa2942563ab222_08_btb_capacity_comparison.png)
...
![图 9：Skymont 返回地址栈深度](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/0fba1124162e7796_09_return_stack_depth.png)
...
![图 10：SPEC CPU2017 分支预测准确率](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/045ddefcd8b8e0a1_10_spec_cpu2017_branch_accuracy.png)
...
![图 11：Skymont 的三集群取指与译码](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/82b4f7b3672c34c1_11_clustered_fetch_decode.png)
...
![图 12：8-byte NOP 下的指令字节供给](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/a54eeefd8c0102c7_12_instruction_fetch_8byte_nops.png)
...
![图 13：4-byte NOP 下的前端吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/1f1e59e6f04954a6_13_instruction_fetch_4byte_nops.jpg)
...
![图 14：Skymont 重命名阶段的优化能力](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/b1f3caaeddc37ce3_14_rename_optimizations.png)
...
![图 15：Skymont 与多代核心的 ROB 容量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/dd86fe55df9958d7_15_rob_capacity.png)
...
![图 16：后端关键资源容量比较](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/7bf6967ee3bdb366_16_backend_resource_capacity.jpg)
...
![图 17：分支重排序容量相对工作负载需求](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/a96b910fe34a36f9_17_branch_reordering_capacity.png)
...
![图 18：Skymont 与 Crestmont 的整数执行端口](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/e0a91a19ad01d2a0_18_integer_execution_ports.png)
...
![图 19：Skymont 的 FP/向量资源](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/f1dd58a66e417a1b_19_fp_vector_resources.png)
...
![图 20：FP/向量结构容量微基准](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/1d8ba98222e97dc2_20_fp_vector_structure_tests.png)
...
![图 21：次正规结果的延迟惩罚](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/dd527a2a00f257bf_21_subnormal_result_penalty.jpg)
...
![图 22：浮点与向量依赖延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/22843a8fa28272ed_22_fp_vector_latency.jpg)
...
![图 23：Skymont 与 Crestmont 的地址生成资源](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/24cc163fa86e949a_23_load_store_agus.jpg)
...
![图 24：Skymont Store-to-Load forwarding 矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/53bcdd60290762cb_24_skymont_store_forwarding.png)
...
![图 25：Crestmont Store forwarding 矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/70419e20defc0e3e_25_crestmont_store_forwarding.png)
...
![图 26：Cache 与内存访问延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/45f664a62d6b1ece_26_cache_memory_latency.png)
...
![图 27：Lunar Lake 的 L2、Memory Side Cache 与 DRAM](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/cd0e454ee664b6d3_27_lunar_lake_memory_hierarchy.png)
...
![图 28：带负载时的 Skymont DRAM 延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/346a5496a99871c4_28_dram_latency.png)
...
![图 29：四核 Cache 与内存带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/93e24127e7fbf94c_29_multicore_cache_memory_bandwidth.png)
...
![图 30：Intel 对 Skymont 性能与能效的定位](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/93f082a17f2dd8b7_30_lunar_lake_skymont_performance_slide.png)
...
![图 31：SPEC CPU2017 Rate-1 估算总分](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/1292bcc85a4b8017_31_spec_vs_low_power_crestmont.png)
...
![图 32：Skymont、两种 Crestmont 与 Zen 5c 的 SPEC 整数子项](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/4ba589959c73cb3c_32_spec_vs_compute_tile_crestmont.png)
...
![图 33：SPEC CPU2017 浮点子项](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/a47e87f40f1aa72e_33_spec_vs_zen5c.png)
...
![图 34：四核 libx264 4K 转码性能](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/75704524d6e59cdd_34_x264_performance.png)
...
![图 35：libx264 的最长延迟 Cache 引用和 miss](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/da86772c288eba6b_35_x264_cache_misses.png)
...
![图 36：四核 y-cruncher 0.8.5.2 性能](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/afc31c919afdc945_36_y_cruncher_performance.png)
...
![图 37：SPEC CPU2017 整数子项 IPC](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/6a16f8f02fdb26eb_37_spec_ipc_comparison.png)
...
![图 38：Lunar Lake 用 Skymont 承接 Teams 负载](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/fab945ed5c034839_38_lunar_lake_teams_slide.jpg)
...
![图 39：Meteor Lake 的 Low Power E-Core 难以完整承接 Teams](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_skymont_wechat_article_zh/9bf8dc8a669a22ab_39_meteor_lake_lpe_core_slide.jpg)
