...
themeName: "学术论文 (副本)"
title: "intel_sandy_bridge_wechat_article_zh"
---
...
![图 1：Sandy Bridge 核心结构](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/32273e2099fd39b0_01_block_diagram.png)
...
![图 2：长模式预测能力](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/ab0b4dc1352d5a70_02_branch_long_pattern.png)

*图 2：在少量难 Branch 下，更大历史表可学习更长 Pattern。曲线显示能力提升，但不能仅凭测试反推出完整 Predictor Algorithm。*

![图 3：Branch 数量增加时的预测表现](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/2009292726a27d68_03_branch_aliasing.jpg)
...
![图 4：Sandy Bridge BTB 容量与延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/96b462fd4677f689_04_btb_capacity.png)
...
![图 5：Indirect Target Predictor 的容量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/3687f765d687ac6a_05_indirect_targets.png)
...
![图 6：不同 Frontend 供给思路](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/0edc7d53a3a1b265_06_frontend_sources.jpg)
...
![图 7：不能进入 Op Cache 的模式](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/5afe2487248d1330_07_uop_limits.png)
...
![图 8：小 Footprint、8-byte NOP 的吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/874c8f4ed8dfbd87_08_long_instruction_throughput.png)

*图 8：正式图注说明使用 8-byte NOP。命中 Op Cache 时，长 x86 指令不再受 L1I Byte Supply/Decode 限制。*

![图 9：溢出 Op Cache 后的吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/8dcda293788a15ae_09_l1i_throughput.png)

*图 9：进入传统 L1I/Decoder 路径后吞吐陡降；约 4-byte 指令时仍可较好供给，而典型 Integer Code 平均略短于 4 B。*

![图 10：从 L2 取指时的带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/543c177adce66836_10_l2_fetch.png)
...
![图 11：ROB-based 与 PRF-based 乱序方案](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/277dec977dd217df_11_prf_rob.png)

*图 11：英文正式图注强调是过度简化示意；Core 2 后 Value 可达 128 bit，早期 P6 最大约 80 bit。PRF 减少 Value Copy，不表示 ROB 消失——ROB 仍负责程序顺序、异常与 Retirement。*

![图 12：Sandy Bridge 乱序资源容量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/60996eed1c1d8e80_12_prf_capacity.jpg)
...
![图 13：PRRT 对可见乱序容量的限制](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/9553326446ff3dc9_13_prrt_limits.png)
...
![图 14：Sandy Bridge 的 AVX Execution Port](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/af2b403723df8a39_14_execution_ports.jpg)
...
![图 15：两条通用 AGU](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/e0c2c3743caeb770_15_agu_ports_actual.jpg)
...
![图 16：Store-to-load Forwarding 延迟矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/24dc91ac641397e2_16_forwarding.png)
...
![图 17：L1/L2 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/8c00e17940fe1f61_17_l1_l2_bandwidth_actual.png)
...
![图 18：中央 GQ 与分布式 L3](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/aec085765906d2da_18_old_uncore_diagram.png)
...
![图 19：六核加载时的 L3 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/893e8fca3e37f21d_19_l3_bandwidth_actual.png)

*图 19：E5-1650 每 Core 超过 9 B/cycle，X5650 仅 4.7 B/cycle。分布式 Slice 和 Ring Bus 带来接近两倍 Per-core Shared-cache Bandwidth。*

![图 20：L3 Hit Latency（cycle）](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/98ad74782576683a_20_l3_latency_cycles.png)
...
![图 21：L3 Hit Latency（ns）](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/7843034803f19b8a_21_l3_latency_ns.png)

*图 21：英文正式图注称 Sandy Bridge 在 L3 Latency 上大胜 Westmere。12 MB Cache 约 10.3 ns，是非常突出的结果。*

![图 22：L3 Probe Filter 与核间一致性路径](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/intel_sandy_bridge_wechat_article_zh/467c19a9d0af59c9_22_coherency_diagram.png)
