...
![图 1：Snapdragon 8+ Gen 1 的核心与共享 Cache](arm_cortex_a710_figures/01_snapdragon_8plus_gen1_cluster.png)
...
![图 2：Snapdragon 8+ Gen 1 的核间延迟](arm_cortex_a710_figures/02_core_to_core_latency.png)
...
![图 3：DSU-110 的 Cluster 与电源域](arm_cortex_a710_figures/03_dsu110_cluster_topology.png)
...
![图 4：Cortex-A710 的受载频率变化](arm_cortex_a710_figures/04_a710_clock_behavior.png)
...
![图 5：Snapdragon 8+ Gen 1 中的 Cortex-A710](arm_cortex_a710_figures/05_a710_block_diagram.jpg)
...
![图 6：Cortex-A710 的方向模式识别](arm_cortex_a710_figures/06_a710_branch_pattern.png)

*图 6：同时扫描 Pattern Length 与静态分支数。低平台代表预测器能稳定学习；台阶之后混入历史不足、容量和混叠。*

![图 7：Skylake 的方向模式识别](arm_cortex_a710_figures/07_skylake_branch_pattern.jpg)

*图 7：同一类测试中的 Skylake，用来说明 A710 已达到较早桌面大核的量级；测试不是跨 ISA 的应用性能比较。*

Zen 3/4 的大预测器仍更强。Arm 必须考虑预测表本身的面积和动态功耗，容量越大，边际准确率收益越小。

![图 8：A710 与其他核心的方向预测对比](arm_cortex_a710_figures/08_branch_predictor_comparison.png)
...
![图 9：A710 的 BTB 容量与分支间距](arm_cortex_a710_figures/09_a710_btb_capacity.png)
...
![图 10：A710 的间接分支目标能力](arm_cortex_a710_figures/10_a710_indirect_targets.png)
...
![图 11：Cortex-A710 前端](arm_cortex_a710_figures/11_a710_frontend.png)
...
![图 12：A710 的指令提取带宽](arm_cortex_a710_figures/12_instruction_bandwidth.png)
...
![图 13：A710 的重命名优化](arm_cortex_a710_figures/13_rename_optimizations.jpg)
...
![图 14：A710、N1 与 Skylake 的乱序容量](arm_cortex_a710_figures/14_ooo_capacity_comparison.jpg)
...
![图 15：A710 与 Skylake 的非访存调度结构](arm_cortex_a710_figures/15_scheduler_comparison.png)
...
![图 16：A710 整数寄存器到端口的数据通路假说](arm_cortex_a710_figures/16_integer_port_hypothesis.png)
...
![图 17：A710、N1 与 Skylake 的 FP/Vector 吞吐](arm_cortex_a710_figures/17_fp_vector_execution.jpg)
...
![图 18：A710 与 A73 的地址转换结构](arm_cortex_a710_figures/18_tlb_comparison.png)
...
![图 19：A710 的 Store-to-Load Forwarding 延迟](arm_cortex_a710_figures/19_store_forwarding.png)
...
![图 20：A710 的 Cache 选项与 Qualcomm 配置](arm_cortex_a710_figures/20_cache_configuration.jpg)
...
![图 21：A710、A75 与桌面核的 Cache/内存延迟](arm_cortex_a710_figures/21_cache_memory_latency.png)
...
![图 22：A710、A75、N1 与 Skylake 的 Cache/内存带宽](arm_cortex_a710_figures/22_cache_memory_bandwidth.png)
