...
![图 1：Neoverse V2 与相关 Server Core 关键规格](arm_neoverse_v2_hot_chips_2023_figures/01_figure.jpg)
...
![图 2：V2 分支预测、取指与多级缓存](arm_neoverse_v2_hot_chips_2023_figures/02_figure.png)
...
![图 3：Micro-op Cache、六宽 Decode 与八宽 Rename](arm_neoverse_v2_hot_chips_2023_figures/03_figure.png)
...
![图 4：V2 调度队列与执行端口](arm_neoverse_v2_hot_chips_2023_figures/04_figure.png)
...
![图 5：三条访存流水线、Load/Store Queue 与结果总线](arm_neoverse_v2_hot_chips_2023_figures/05_figure.png)
...
![图 6：V2 的 Inclusive L2 组织](arm_neoverse_v2_hot_chips_2023_figures/06_figure.png)
...
![图 7：L2 Transaction Queue 与系统接口](arm_neoverse_v2_hot_chips_2023_figures/07_figure.png)
...
![图 8：CMN-700 最大 12×12 配置](arm_neoverse_v2_hot_chips_2023_figures/08_figure.png)
...
![图 9：V2 的多类 Hardware Prefetcher](arm_neoverse_v2_hot_chips_2023_figures/09_figure.png)
...
![图 10：Arm 用于估算的 32 核模拟平台](arm_neoverse_v2_hot_chips_2023_figures/10_figure.png)

若 Trace 与完整运行相关良好，V2 单线程 SPEC2017 约增 13%。Prefetch 占最大部分，Scheduler 与 Load/Store 优化贡献较小；各 Block 单独叠加在 N1 Base 上，合计收益低于简单相加。

![图 11：单线程 SPEC 提升的 Block 分解](arm_neoverse_v2_hot_chips_2023_figures/11_figure.png)

一些投入在单线程影响较小，多线程 SPECrate 估算提升更大。

![图 12：单线程与每核一份工作负载的增益](arm_neoverse_v2_hot_chips_2023_figures/12_figure.png)
...
![图 13：V1/V2 工艺与 Core Area](arm_neoverse_v2_hot_chips_2023_figures/13_figure.jpg)
...
![图 14：V2 与 Zen 4c Die 区域对照](arm_neoverse_v2_hot_chips_2023_figures/14_figure.jpg)
...
![图 15：Neoverse V2 在 Arm Server 路线中的位置](arm_neoverse_v2_hot_chips_2023_figures/15_figure.jpg)
