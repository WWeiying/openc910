...
![图 1：Cortex-A510 双核合并配置](arm_cortex_a510_figures/01_merged_core_configuration.png)
...
![图 2：Cortex-A510 与 A55 的流水阶段](arm_cortex_a510_figures/02_a510_a55_pipeline.png)
...
![图 3：Cortex-A510 的随机分支模式识别](arm_cortex_a510_figures/03_branch_pattern_recognition.png)
...
![图 4：A510 的 BTB 容量与目标延迟](arm_cortex_a510_figures/04_btb_capacity_latency.png)
...
![图 5：Taken Branch 足迹扩大后的延迟](arm_cortex_a510_figures/05_taken_branch_footprint.png)
...
![图 6：单核指令供给带宽](arm_cortex_a510_figures/06_instruction_fetch_bandwidth.png)
...
![图 7：同簇与跨簇双核的代码带宽](arm_cortex_a510_figures/07_dual_core_code_bandwidth.png)
...
![图 8：Cortex-A510 执行流水线](arm_cortex_a510_figures/08_execution_pipeline.png)
...
![图 9：双核合并配置中的共享功耗域](arm_cortex_a510_figures/09_shared_fpu_configuration.png)
...
![图 10：单核与双核负载下的 FP/Vector 吞吐](arm_cortex_a510_figures/10_fp_vector_throughput.jpg)
...
![图 11：Store-to-load Forwarding 延迟矩阵](arm_cortex_a510_figures/11_store_forwarding_latency.png)
...
![图 12：Load/Store 对齐对吞吐的影响](arm_cortex_a510_figures/12_load_store_alignment.png)
...
![图 13：A510 与 A55 的 L1D 读取带宽](arm_cortex_a510_figures/13_l1d_bandwidth.png)
...
![图 14：单线程 Cache 与内存读取带宽](arm_cortex_a510_figures/14_cache_memory_bandwidth.png)
...
![图 15：双核同时读取时的共享层级带宽](arm_cortex_a510_figures/15_dual_core_bandwidth.png)
...
![图 17：系统报告的 A510 频率范围](arm_cortex_a510_figures/17_clock_limits.png)
...
![图 18：A510 从空闲到最高实测频率的过程](arm_cortex_a510_figures/18_clock_ramp.png)
...
![图 19：A510 单核与双核 Cluster 的功耗域](arm_cortex_a510_figures/19_single_dual_core_configuration.png)
...
![图 20：共享单元带来的验证风险](arm_cortex_a510_figures/20_shared_resource_validation.png)
...
![图 21：可选的 A510 Cluster 与 FPU 组合](arm_cortex_a510_figures/21_fpu_configuration_choice.jpg)
