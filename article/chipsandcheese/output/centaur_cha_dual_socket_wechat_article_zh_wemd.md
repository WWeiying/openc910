...
themeName: "学术论文 (副本)"
title: "centaur_cha_dual_socket_wechat_article_zh"
---
...
![图 1：CHA 双 Socket/NUMA 拓扑](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/682da80eabe81ca4_01_figure.jpg)
...
![图 2：CHA 本地/远端 DRAM 延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/762816b561d23f1e_02_figure.png)

*图 2：跨 Socket 多约 92 ns，远端接近本地两倍。*

![图 3：Broadwell 双路 Early Snoop](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/3353da5892d2a6d7_03_figure.png)
...
![图 4：Broadwell CoD 四 Node Memory Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/edaf5a76cb237d98_04_figure.png)

*图 4：CHA 只有两 Node 时显得平庸；Intel 同时选择三个 Remote Node 时也接近。*

![图 5：Milan-X NPS2 延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/de7ed97497344eec_05_figure.png)
...
![图 6：CHA 本地与远端读取带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/dc56266daba80303_06_figure.png)

*图 6：远端略高于 1.3 GB/s，甚至低于优秀 NVMe 的顺序读取速度，明显不正常。*

![图 7：Broadwell 双路带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/799be96a5dabe21f_07_figure.png)

*图 7：每个 Socket 仅有一个 Node 时，本地接近 60 GB/s，远端为 21.3 GB/s；Westmere 三通道 DDR3 本地为 20.4 GB/s、远端为 11.2 GB/s，也远高于 CHA。*

![图 8：Broadwell CoD 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/1d91f7bb7ebb2986_08_figure.png)

*图 8：每个 7 核 Node 的远端带宽仍高于 CHA；同一 Die 跨 Node 却约减半，显示内部 Ring/Home 约束。*

![图 9：Milan-X NPS2 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/9f4611a2ceeb2493_09_figure.png)
...
![图 10：CHA Atomic Core-to-core Matrix](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/2e21d55d8709f822_10_figure.png)
...
![图 11：Westmere Core-to-core Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/a71ac37eb2b49df3_11_figure.png)

*图 11：Central Global Queue 简单，利于 Coherence；代价是普通 L3 延迟/带宽不如后来 Distributed Ring。*

![图 12：Broadwell CoD Core-to-core](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/94378c3d03a7f239_12_figure.png)

*图 12：同 Cluster 的 Inclusive L3 + Core Valid Bit 很快；L3 miss 后 Directory 较慢，同一 Die 跨 Node 已超过 100 ns，跨 Die 只再多 10～20 ns。*

![图 13：Broadwell Early Snoop Core-to-core](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/3f91e11fcddf6ead_13_figure.png)
...
![图 14：单 NUMA Node 到远端的最大带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/82f923d45e4e1ca4_14_figure.png)

*图 14：使用该 Node 的全部 Thread，仍未把 Link 跑起来。*

文章猜测 Link 前有 Queue，但 Centaur 小团队忙于 Server 新技术，未完成验证或调优。

![图 15：最小跨 Socket Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/centaur_cha_dual_socket_wechat_article_zh/fa55d45fb2836a7f_15_figure.png)
