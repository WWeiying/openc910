...
![图 1：论文总结 Arm 与 x86 的实现收敛](arm_or_x86_isa_figures/01_figure.jpg)
...
![图 2：Haswell 各组件功耗模型中的 Decoder](arm_or_x86_isa_figures/02_figure.jpg)

Ivy Bridge 的在线功耗建模也显示 Fetch+Decode 远小于其他核心组件。

![图 3：Ivy Bridge Fetch/Decode 功耗估计](arm_or_x86_isa_figures/03_figure.jpg)
...
![图 4：ThunderX3 的 6% Micro-op Expansion 改进](arm_or_x86_isa_figures/04_figure.png)

A64FX Manual 也列出一条 Armv8 Base Instruction 对应多个 Micro-op。

![图 5：A64FX 指令表中的多 Micro-op 指令](arm_or_x86_isa_figures/05_figure.jpg)
...
![图 6：Zen 2 与 Ampere 编译 gem5 的时间](arm_or_x86_isa_figures/06_figure.png)

编译中两边大致同一范围，考虑 Zen 2 更大、更高频，N1 表现合理。

![图 7：HEVC/x265 编码的巨大差距](arm_or_x86_isa_figures/07_figure.png)
