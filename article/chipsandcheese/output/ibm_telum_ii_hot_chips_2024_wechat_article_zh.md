...
![图 1：Telum II 裸片中的 8 个 5.5 GHz 核心、10 个 36 MB L2、DPU 与 24 TOPS AI 加速器](ibm_telum_ii_hot_chips_2024_figures/01_figure.jpg)
...
![图 2：Oryon 约 5.28 ns 的 12 MB L2 延迟曲线，用于对照 Telum II 的 36 MB、3.6 ns](ibm_telum_ii_hot_chips_2024_figures/02_figure.jpg)
...
![图 3：传统 Zen 3/4/5 的私有 L2（绿）与按地址固定分片的共享 L3（红）](ibm_telum_ii_hot_chips_2024_figures/03_figure.png)
...
![图 4：Telum II virtual L3：被某核 L2 淘汰的 line 保留在其他较空闲的 L2 中](ibm_telum_ii_hot_chips_2024_figures/04_figure.png)
...
![图 5：virtual-L3 line 插在中间 LRU 位置，本地 L2 fill 仍进入 MRU](ibm_telum_ii_hot_chips_2024_figures/05_figure.png)
...
![图 6：上一代 Z16/Telum 的 CPC（Central Processor Complex）drawer](ibm_telum_ii_hot_chips_2024_figures/06_figure.png)
...
![图 7：更早的 z15 通过 System Controller 在一个 drawer 内提供 960 MB L4](ibm_telum_ii_hot_chips_2024_figures/07_figure.jpg)
...
![图 8：第一代 Telum 的 L2 分段与 core-nest 设计变化](ibm_telum_ii_hot_chips_2024_figures/08_figure.jpg)
...
![图 9：Z16 单线程可见的 32 MB private L2、224 MB shared virtual L3 与 1.75 GB virtual L4](ibm_telum_ii_hot_chips_2024_figures/09_figure.png)

Telum II 在三个层级上继续扩容。IBM 交流时还使用“congruence class”描述 virtual L3，查找后可知它基本对应其他厂商常说的 cache set。

![图 10：IBM 传统术语与行业常见术语对照，congruence class 即 set](ibm_telum_ii_hot_chips_2024_figures/10_figure.jpg)
...
![图 11：IBM 官方 Telum II 芯片渲染图](ibm_telum_ii_hot_chips_2024_figures/11_figure.jpg)
...
![图 12：Z16 dual-chip module 的高速链路，同模块与跨模块带宽均显著高于客户端 CCD](ibm_telum_ii_hot_chips_2024_figures/12_figure.jpg)
