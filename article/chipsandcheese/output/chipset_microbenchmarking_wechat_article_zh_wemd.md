...
themeName: "学术论文 (副本)"
title: "chipset_microbenchmarking_wechat_article_zh"
---
...
![图 1：ASUS M5A99X EVO R2.0 上覆盖 SB950 Southbridge 的散热片](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/1859c96982c2d321_01_figure.jpg)
...
![图 2：GPU 访问 Host Memory 的 Vulkan Pointer-chase 路径](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/0758b73315994a5b_02_figure.png)
...
![图 3：Piledriver Northbridge 的 Probe Result Event；此处 Northbridge 在 CPU 内，不是 Chipset](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/72af20f090851eea_03_figure.png)

![图 4：AMD Family 15h BKDG 中 Probe Result Event 的定义](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/2ff1e869d8eca143_04_figure.jpg)
...
![图 5：两块 AM5 主板 Block Diagram，绿色为被测 Slot](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/5b9ba54281f5a9de_05_figure.jpg)

CPU Lane Baseline 约 650 ns；B650 经过一颗 PROM21 为 1221 ns，即增加 569.7 ns；X670E 经过两颗则比 Baseline 多 921.3 ns。

![图 6：AM5 CPU Lane、一跳与两跳 Chipset Lane 的 GPU→Host Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/5619d10581e7c2ec_06_figure.png)

CPU Lane 上 T1000 Cache-hit Bandwidth 不变；换到 Chipset Lane 后降到略高于 25 GB/s，一颗或两颗 PROM21 差异很小。

![图 7：AM5 不同 Slot 的 T1000 Cache-hit Bandwidth](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/343d370ad6a1ad86_07_figure.png)
...
![图 8：Intel Z890 Chipset Block Diagram](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/d6f2aac5074a4434_08_figure.jpg)

Arrow Lake Baseline 为 785 ns，比 Zen 5 高；经 PCH 再加约 550 ns，与单颗 PROM21 接近。

![图 9：Arrow Lake CPU 与 PCH Slot Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/181a0c6640d19733_09_figure.png)
...
![图 10：Arrow Lake 上 T1000 与其他 GPU 的 Cache 行为差异](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/34f3e179acd41fb5_10_figure.png)

## Skylake：老 Z170 的 PCH Hop 反而较低

MSI Z170 Gaming Pro Carbon 顶部 x16 直连 CPU，中间 Slot 可把 16 Lane 拆成 2×8，底部 Slot 接 Z170 PCH。

![图 11：Z170 主板拓扑与被测 Slot](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/a91c46b6dde77b96_11_figure.jpg)

CPU Lane Baseline 535.59 ns，是所有现代平台里很好的结果；PCH 增加 338 ns，虽然远高于普通 DRAM Access，仍优于 AM5/Z890。

![图 12：Skylake CPU 与 Z170 PCH Slot Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/bddbd1be20f4a8e7_12_figure.png)

直连时 T1000 L1 Bandwidth 不变，L2 Hit 奇怪地稍低但仍远超 VRAM Bandwidth；经 PCH 后 Hit Bandwidth 降至略高于 51 GB/s。

![图 13：Z170 不同 Slot 的 T1000 Cache-hit Bandwidth](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/0bd50576f6b08c6b_13_figure.png)
...
![图 14：AMD 990X/RD980 Northbridge Datasheet Block Diagram](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/13609eeca832ee11_14_figure.jpg)

RD980 Lane Baseline 769.67 ns，介于 Zen 5 与 Arrow Lake，考虑 PCIe 并非直连 CPU，表现相当不错。

![图 15：AM3+ RD980 Northbridge Slot Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/ab065f0210a839e4_15_figure.png)

再经过 SB950 增加 602 ns，高于 Arrow Lake PCH/单颗 PROM21，却低于 X670E 双 PROM21。

![图 16：RD980 与 SB950 Slot 的 Latency 对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/7af5290142a56457_16_figure.png)
...
![图 17：4 KB CPU→VRAM 与 GPU→System Memory Latency 并列](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/a4b63db356f84ed0_17_figure.png)

## 结语：数百纳秒很大，但对现代 Chipset 用途通常不重要

![图 18：T1000 的 PCIe Connector 触点](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/chipset_microbenchmarking_wechat_article_zh/86edd2d4563c6935_18_figure.jpg)
