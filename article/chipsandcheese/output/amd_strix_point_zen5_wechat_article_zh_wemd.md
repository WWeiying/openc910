...
themeName: "学术论文 (副本)"
title: "amd_strix_point_zen5_wechat_article_zh"
---
...
![图 1：Strix Point 与 Zen 5](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/5ec14b8e59528c5f_01_hero.jpg)

*图 1：Strix Point 是 Zen 5 Architecture 的首发载体；移动功耗和面积约束决定了它与桌面 Granite Ridge 不会采用完全相同的物理资源。*

![图 2：测试用 ASUS ProArt PX13](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/cdd97245ce2eacd6_02_laptop.jpg)
...
![图 3：Strix Point 的双 Cluster 组织](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/d93c1849d90b24db_03_clusters.jpg)
...
![图 4：Strix Point 两组核心的频率](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/80d925887be48331_04_strix_clock.png)

*图 4：图中为简洁把两组称作 P/E；Clock 由 Dependent Integer Addition Latency 估算。这里的 P/E 只代表物理实现与频率，不表示两套 ISA 或核心 Architecture。*

![图 5：Meteor Lake 的核心频率对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/e963702c770246c4_05_meteor_clock.png)

*图 5：Meteor Lake 两颗 Redwood Cove 可到 4.8 GHz，其余为 4.5 GHz，更需要 Scheduler Awareness；同一 Crestmont Cluster 内频率一致。*

![图 6：两组 Cluster 的 Boost 响应](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/dd1fe6f1ba13837a_06_boost.png)
...
![图 7：单/双 Cluster 的 DRAM 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/cf5c92e7f6246658_07_memory_bandwidth.png)
...
![图 8：Strix Point 的 Core-to-core Latency](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/066438f122a750dc_08_core_latency.png)

*图 8：同 Cluster 很快，跨 Cluster 明显抬升；它是 APU Fabric 与 Coherency 的端到端结果，不能归成 Zen 5 Pipeline Latency。*

![图 9：Ryzen 9 3950X 的核间延迟对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/31dd15d46fbca564_09_zen1_latency.png)
...
![图 10：Zen 5 核心结构总览](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/333098311d52ac98_10_core_overview.png)
...
![图 11：长模式分支预测能力](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/bff0e0a37ae4d6ff_11_pattern_prediction.png)
...
![图 12：Zen 5 的 BTB 容量曲线](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/c3fc742f53523801_12_btb_capacity.png)
...
![图 13：Victim-cache BTB 示意](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/b36aab3a32c67acf_13_btb_diagram.jpg)
...
![图 14：Taken Branch 吞吐与 Footprint](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/4aad7bc10ee9eac0_14_taken_throughput.png)
...
![图 15：两组 Fetch/Decode Cluster](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/e1eab22f0b3b06a1_15_decode_cluster.jpg)

*图 15：表面上类似 Intel E-Core，线程映射方式却不同。最大 Decoder 吞吐要两条 SMT Thread 同时活跃。*

![图 16：单线程 Decoder 供给](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/970166e87afb0a39_16_single_thread_decode.png)

*图 16：单 SMT Thread 在 Op Cache 外只能使用一组四宽 Decoder；插入 Taken Branch 没有提高吞吐。*

![图 17：双线程合计 Decoder 供给](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/b9fa42b25732fcb8_17_dual_thread_decode.png)
...
![图 18：L2 取指时的 Frontend 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/a15d6cc41216d0e4_18_l2_fetch.png)
...
![图 19：Rename/Allocate 优化吞吐](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/537b247c75c7ce0d_19_rename_opt.png)
...
![图 20：Zen 5 与其他核心的 Backend 容量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/cfa5ace654a90925_20_backend_resources.jpg)
...
![图 21：YMM/ZMM 混合分配](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/349c5eb26e42401f_21_vector_rf_mix.png)
...
![图 22：FP/Vector 执行端口](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/7ff633b6a62c2402_22_fp_ports.jpg)
...
![图 23：Zen 5 统一 Integer Scheduler](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/918b3689eb9fd13b_23_int_scheduler.jpg)

*图 23：统一 Queue 让 Entry 可在不同 Operation 间共享，降低某一分区先满而其他分区空闲的风险。*

![图 24：Zen 4 的分布式 Scheduler 对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/dbfbb9940194f2d1_24_zen4_scheduler.jpg)
...
![图 25：AGU 与 58-entry Scheduler](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/101226a193e099ad_25_agu_layout.jpg)
...
![图 26：Zen 5 Store-to-load Forwarding](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/13546f212ee077aa_26_store_forwarding.png)

*图 26：英文正式图注说明采用 Henry Wong 的方法。完全包含但非精确匹配为 7 cycle；Partial Overlap 导致快转发失败时约 14 cycle。*

![图 27：Zen 4 Forwarding 对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/7ddf58c35b127fe8_27_zen4_forwarding.png)
...
![图 28：Zen 5 TLB 层级](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/9ff64712530c3042_28_tlb.jpg)
...
![图 29：Zen 5 Cache 层级与带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/b3f2002f26460176_29_cache_overview.jpg)
...
![图 30：L2 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/c10bbf795741e495_30_l2_bandwidth.png)
...
![图 31：单核 L3 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/d4896818016832f4_31_l3_bandwidth.png)

*图 31：双向 Aggregate 不应误写成单向接口翻倍；它说明读写 Path 可并行利用。*

![图 32：全核 Cache Bandwidth](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/0a4842c249fc9d04_32_all_core_cache.png)
...
![图 33：以纳秒表示的 Cache/Memory 延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/23ea715a61e39c04_33_cache_latency_ns.png)
...
![图 34：以 Cycle 表示的 Cache 延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/015b64e3029bdae7_34_cache_latency_cycles.png)
...
![图 35：四核 Video Encoding 性能](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/e9724229230d6e80_35_video_performance.png)
...
![图 36：Video Encoding 的 IPC/指令量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/2c40f7c37f36a69e_36_video_ipc.png)
...
![图 37：Video Encoding 的预测准确率](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/4705ec7caed944f0_37_predictor_accuracy.png)
...
![图 38：Zen 5 结构变化汇总](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/983a82a79bcd929b_38_core_summary.png)
...
![图 39：Zen 5 对 SMT 的结构投入](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/eea2f8c1d1423afb_39_smt_focus.jpg)
...
![图 40：Strix Point Die](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_point_zen5_wechat_article_zh/cde5cfda2610e4f4_40_die.jpg)
