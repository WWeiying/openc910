...
![图 1：P550 的分支模式长度与静态分支数量扫描](cpu_microarchitecture_measurement_methodology_figures/01_branch_pattern_sweep.jpg)
...
![图 2：P550 的 Taken 分支目标供给台阶](cpu_microarchitecture_measurement_methodology_figures/02_btb_capacity_latency.png)
...
![图 3：P550 与 Cortex-A75 的返回地址栈深度测试](cpu_microarchitecture_measurement_methodology_figures/03_ras_depth.png)
...
![图 4：P550 与 Cortex-A75 的指令取数带宽](cpu_microarchitecture_measurement_methodology_figures/04_fetch_bandwidth.png)
...
![图 5：P550 与 Cortex-A75 的可见乱序资源](cpu_microarchitecture_measurement_methodology_figures/05_reorder_capacity.jpg)
...
![图 6：Cortex-X925 的整数分区调度器容量测试](cpu_microarchitecture_measurement_methodology_figures/06_scheduler_partitioning.png)
...
![图 7：P550 的 Store-to-Load 偏移矩阵](cpu_microarchitecture_measurement_methodology_figures/07_store_forwarding_matrix.jpg)
...
![图 8：P550 与 Cortex-A75 的 TLB 容量和层次](cpu_microarchitecture_measurement_methodology_figures/08_tlb_capacity.png)
...
![图 9：P550 的 Cache 与内存延迟台阶](cpu_microarchitecture_measurement_methodology_figures/09_cache_latency_stairs.png)
...
![图 10：用 Little’s Law 估算 Zen 4 的 L2 miss 跟踪深度](cpu_microarchitecture_measurement_methodology_figures/10_l2_miss_queue_littles_law.jpg)
...
![图 11：Sapphire Rapids 的核间一致性延迟矩阵](cpu_microarchitecture_measurement_methodology_figures/11_core_to_core_latency_matrix.png)
...
![图 12：SPEC CPU2017 中两个低 IPC 子项的 Top-down 分解](cpu_microarchitecture_measurement_methodology_figures/12_spec_topdown.png)
...
![图 13：多款 CPU 从空闲到最高 Boost 的时间](cpu_microarchitecture_measurement_methodology_figures/13_frequency_ramp.png)
