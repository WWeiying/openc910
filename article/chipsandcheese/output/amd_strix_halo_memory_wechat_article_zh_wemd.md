...
themeName: "学术论文 (副本)"
title: "amd_strix_halo_memory_wechat_article_zh"
---
...
![图 1：搭载 Strix Halo 的 ASUS ROG Flow Z13](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/eeacfd7694000a3a_01_figure.jpg)
...
![图 2：GPU 侧 Cache 与内存延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/4702087e119ee034_02_figure.png)
...
![图 4：Vulkan 工作集下的 Cache 与 DRAM 带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/57b631342986db4d_04_figure.png)
...
![图 5：早期前台/后台游戏的 UMC 与片上带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/49fb6fdfaa513294_05_figure.png)
...
![图 6：更新后 Vulkan 再次显示 Infinity Cache](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/e15440fb68c6d55e_06_figure.png)
...
![图 7：不同 OpenCL 分配标志下的 Strix Halo 延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/c6e2eb5a58cfb6af_07_figure.png)

*图 7：普通 Device Buffer 出现 Cache 台阶，Host Pointer 类分配直接呈现 DRAM 路径。统一内存并不意味着所有虚拟内存类型共享相同 Cache 属性。*

![图 8：RX 9070 的 Host Memory 行为](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/0edd883643d2030d_08_figure.png)

*图 8：离散 RX 9070 也不把 Host-side Memory 放入 Infinity Cache，但跨 PCIe 后延迟接近 1 μs；Strix Halo 的统一物理内存让 zero-copy 延迟基本不变。*

![图 9：GPU 侧与 Host-visible Memory 延迟对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/839d6aa3f627e13c_09_figure.png)
...
![图 10：细粒度 SVM 的 CPU—GPU 往返延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/4e3ba0f666fcab41_10_figure.png)
...
![图 11：OpenCL Copy API 的双向带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/44dc7ff4ee9bc6fe_11_figure.png)
...
![图 12：CPU→GPU Copy 的软件、CS 与 UMC 流量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/eb2b7462a93ffe76_12_figure.png)
...
![图 13：GPU→CPU Copy 的流量](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/0db7e4f6e9078e59_13_figure.png)
...
![图 14：Strix Halo 与其他 CCD/Tile 的接口对照](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/7781e2bfca8d469f_14_figure.png)
...
![图 15：真实工作负载的读写比例](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/fa3232e7b4db430e_15_figure.png)

*图 15：SPEC、编译、视频和游戏中的读流量普遍占大头。链路设计若只增加写带宽，很难缓解主要瓶颈。*

![图 16：不同平台的簇—系统带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/34660cc500f6b660_16_figure.png)
...
![图 17：单 CCX 受载内存延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/8936d453bad22071_17_figure.png)
...
![图 18：整机 CPU 受载延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/c9731754d4bf6b89_18_figure.png)
...
![图 19：Zen 2 IFOP SerDes 结构](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/e0390469eb2638a2_19_figure.jpg)
...
![图 20：一组较好的核间延迟矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/5c20df5a1353ff9f_20_figure.jpg)

*图 20：同 CCX 绿色区域较快，跨 CCX 约 100 ns 起。矩阵中的差异不只代表核心距离，还包含地址归属的 L3 Slice 与 CS。*

![图 21：较差 Home 位置下的矩阵](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/0966f58ed6fc3157_21_figure.jpg)

*图 21：跨 CCX 区域可到 120 ns，可能是负责该地址的 CS 离 CPU Endpoint 更远。文章用“likely”描述这一归因，没有公开 Fabric 布局可直接确认。*

![图 22：Strix Halo 与桌面 Ryzen 的跨 CCX 延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/cb454ed1a07d6389_22_figure.jpg)
...
![图 23：独显游戏中的 CPU 外部请求延迟分布](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/9fe69f814e567409_23_figure.png)

*图 23：使用独显时，CPU 带宽需求普遍很低，延迟只比基线略高。PMU 值与软件微基准口径不同，不能直接混成一条曲线。*

使用 Strix Halo iGPU 后，CPU 外部请求基线约 140 ns，许多一秒区间升到约 200 ns。

![图 24：GPU 带宽负载下的 CPU 延迟](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/4aa840d1f8a05ffb_24_figure.png)
...
![图 25：CPU 延迟与 GPU 负载的组成](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/04179c9650a9aae7_25_figure.png)

*图 25：GPU 越接近带宽型，CPU 延迟越高。面积图还区分 CPU、GPU 可见带宽，避免只用一个总值描述竞争。*

再加入两个 CPU 读带宽线程后，极端区间延迟超过 300 ns，显示 GPU 可以挤压 CPU。

![图 26：CPU 与 GPU 共同加压](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/0077eada6d64ce00_26_figure.png)
...
![图 27：Cyberpunk 2077 的平均帧率](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/4b04a95666808a10_27_figure.png)
...
![图 28：微基准、PMU 与 CPU 工作负载](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/f7f3419c57afbca0_28_figure.png)

*图 28：大多数 CPU 应用落在低带宽、接近基线延迟区域，解释了为何 CPU 入口没有做成 GPU 那样宽。Y-Cruncher 不代表常见客户端负载。*

![图 29：游戏期间的 Fabric CPU/GPU 请求带宽](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/f5da105d5e84510a_29_figure.png)
...
![图 30：ROG Flow Z13 与初代 Surface Pro](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/add1897856beb717_30_figure.jpg)

*图 30：大 iGPU 的价值在于把可观图形性能与大共享内存塞进轻薄形态。继续放大 GPU 会遇到散热、成本和与独显竞争的问题。*

![图 31：更大 iGPU 的收益与挑战](https://gongzhonghao1-1402552401.cos.ap-shanghai.myqcloud.com/wechat/articles/amd_strix_halo_memory_wechat_article_zh/a4ec58cab2b7d2d0_31_figure.png)
